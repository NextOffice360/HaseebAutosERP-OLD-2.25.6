...
Object.assign(TRANSLATIONS, {
  ...
  'pwa.multiMatchesTail': { key: 'pwa.multiMatchesTail', en: ' matches — pick from the list', roman: ' matches — list se chunein', ur: ' میدیں — فہرست سے چنیں' },
  ...
  'pwh.multiMatchesTail': { key: 'pwh.multiMatchesTail', en: ' matches — pick from the list', roman: ' matches — list se chunein', ur: ' میدیں — فہرست سے چنیں' },
