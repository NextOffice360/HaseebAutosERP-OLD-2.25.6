...
Object.assign(TRANSLATIONS, {
  ...
  'sc2.noPrYet': { key: 'sc2.noPrYet', en: 'No purchase returns — create via "New purchase return"', roman: 'Koi purchase return nahi — "New purchase return" se banayein', ur: 'کوئی خریداری واپسی نہیں — "نئی خریداری واپسی" سے بنائیں' },
  'sc2.creditNeedsSupplier2': { key: 'sc2.creditNeedsSupplier2', en: 'Credit (udhaar) requires a supplier', roman: 'Credit (udhaar) ke liye supplier lazmi hai', ur: 'کریڈٹ (ادھار) کے لیے سپلائر لازمی ہے' },
  'pos.openShopHint': { key: 'pos.openShopHint', en: 'Tap "Open the shop" — the day starts with opening cash.', roman: '"Shop kholein" dabayen — opening cash ke sath din shuru hoga.', ur: '"دکان کھولیں" پر ٹیپ کریں — دن اوپننگ کیش کے ساتھ شروع ہو گا۔' },
  'pos.askManagerOpen': { key: 'pos.askManagerOpen', en: 'Please ask a manager/cashier to open the shop.', roman: 'Barah-e-karam manager/cashier se shop khulwayein.', ur: 'براہِ کرم مینیجر/کیشیئر سے دکان کھلوائیں۔' },
  'pos.shopGateToast': { key: 'pos.shopGateToast', en: 'Shop must be open before starting a sale — first action (item add) was blocked.', roman: 'Sale shuru karne se pehle shop khulna zaroori hai — pehla action (item add) rok diya gaya.', ur: 'سیل شروع کرنے سے پہلے دکان کا کھلا ہونا ضروری ہے — پہلا ایکشن (آئٹم شامل) روک دیا گیا۔' },
  'pos.openShopBtn': { key: 'pos.openShopBtn', en: '🗪 Open the shop', roman: '🗪 Shop kholein', ur: '🗪 دکان کھولیں' },
  'pos.shopClosedBanner': { key: 'pos.shopClosedBanner', en: 'Shop is closed — sale actions are blocked. Open the shop first.', roman: 'Shop band hai — sale ke kaam rok diye gaye. Pehle shop kholein.', ur: 'دکان بند ہے — سیل کے کام روک دیے گئے۔ پہلے دکان کھولیں۔' },
  'pos.bulkHint': { key: 'pos.bulkHint', en: 'Scan → Bulk List → Add All · or tick from search/📋 list', roman: 'Scan → Bulk List → Add All · ya search/📋 list se tick karein', ur: 'اسکین → بلک لسٹ → سب شامل کریں · یا تلاش/📋 فہرست سے ٹک کریں' },
  'pos.bulkBadgeEnd': { key: 'pos.bulkBadgeEnd', en: ' · close', roman: ' · band karein', ur: ' · بند کریں' },
  'pos.scanOrTypePh': { key: 'pos.scanOrTypePh', en: 'Scan or type — name / code / barcode / brand / model… (F2)', roman: 'Scan ya type karein — name / code / barcode / brand / model… (F2)', ur: 'اسکین یا ٹائپ کریں — نام / کوڈ / بارکوڈ / برانڈ / ماڈل… (F2)' },
  'pos.cameraScan': { key: 'pos.cameraScan', en: 'Scan barcode/QR with camera', roman: 'Camera se barcode/QR scan karein', ur: 'کیمرے سے بارکوڈ/کیو آر اسکین کریں' },
  'pos.endBulkSession': { key: 'pos.endBulkSession', en: 'End bulk session', roman: 'Bulk session khatam karein', ur: 'بلک سیشن ختم کریں' },
  'pos.bulkBadgeInit': { key: 'pos.bulkBadgeInit', en: ' 🔁 Bulk ON · 0 · close', roman: ' 🔁 Bulk ON · 0 · band karein', ur: ' 🔁 بلک آن · 0 · بند کریں' },
  'pos.bulkAddHint': { key: 'pos.bulkAddHint', en: 'Add multiple products at once from the checkbox list (like GRN/PO) — BULK ADD', roman: 'Checkbox list se multiple products ek saath add karein (GRN/PO jaisa) — BULK ADD', ur: 'چیک باکس فہرست سے کئی پروڈکٹس ایک ساتھ شامل کریں (جی آر این/پی او جیسا) — بلک ایڈ' },
  'pos.gridBulkHint': { key: 'pos.gridBulkHint', en: 'Grid bulk — tick tiles to add multiple', roman: 'Grid bulk — tiles par tick karke multiple add', ur: 'گرڈ بلک — ٹائلوں پر ٹک کر کئی شامل کریں' },
  'pos.gridSelectOn': { key: 'pos.gridSelectOn', en: 'Grid select ON — tick tiles', roman: 'Grid select ON — tiles tick karein', ur: 'گرڈ سلیکٹ آن — ٹائلیں ٹک کریں' },
  'pos.cartLinesSelect': { key: 'pos.cartLinesSelect', en: 'Select cart lines — bulk delete / qty', roman: 'Cart lines select karein — bulk delete / qty', ur: 'کارٹ لائنیں منتخب کریں — بلک ڈیلیٹ / qty' },
  'pos.noMatches': { key: 'pos.noMatches', en: 'No matches', roman: 'Kuch nahi mila', ur: 'کچھ نہیں ملا' },
  'pos.quickViewHint': { key: 'pos.quickViewHint', en: 'ⓘ click for more details', roman: 'ⓘ aur detail ke liye click karein', ur: 'ⓘ مزید تفصیل کے لیے کلک کریں' },
  'pos.makeFavourite': { key: 'pos.makeFavourite', en: 'Make favourite', roman: 'Favourite banayein', ur: 'پسندیدہ بنائیں' },
  'pos.noHeldBills': { key: 'pos.noHeldBills', en: 'No held bills', roman: 'Koi held bill nahi', ur: 'کوئی ہولڈ بل نہیں' },
  'pos.findItemHint': { key: 'pos.findItemHint', en: 'Search and tap an item, or scan a barcode', roman: 'Item search kar ke tap karein, ya barcode scan karein', ur: 'آئٹم تلاش کر کے ٹیپ کریں، یا بارکوڈ اسکین کریں' },
  'pos.decrease': { key: 'pos.decrease', en: 'Decrease', roman: 'Kam karein', ur: 'کم کریں' },
  'pos.increase': { key: 'pos.increase', en: 'Increase', roman: 'Zyada karein', ur: 'زیادہ کریں' },
  'pos.ledgerBtn': { key: 'pos.ledgerBtn', en: '📒 Credit ledger', roman: '📒 Udhaar', ur: '📒 ادھار' },
  'pos.minPriceTail': { key: 'pos.minPriceTail', en: ' — cannot be lower', roman: ' se kam nahi', ur: ' سے کم نہیں' },
  'pos.custSearchPh': { key: 'pos.custSearchPh', en: 'Name or phone… (type to filter instantly)', roman: 'Naam ya phone… (type karein, foran filter hoga)', ur: 'نام یا فون… (ٹائپ کریں، فوراً فلٹر ہو گا)' },
  'pos.noCustomer': { key: 'pos.noCustomer', en: 'No customer found', roman: 'Koi customer nahi mila', ur: 'کوئی کسٹمر نہیں ملا' },
  'pos.selectCustomer': { key: 'pos.selectCustomer', en: 'Select a customer', roman: 'Customer select karein', ur: 'کسٹمر منتخب کریں' },
  'pos.openingUdhaar': { key: 'pos.openingUdhaar', en: 'Opening credit', roman: 'Opening udhaar', ur: 'افتتاحی ادھار' },
  'pos.dueClosingHtml': { key: 'pos.dueClosingHtml', en: '<span>Current due (credit) — Closing</span><span>', roman: '<span>Current Due (udhaar) — Closing</span><span>', ur: '<span>موجودہ بقایا (ادھار) — اختتام</span><span>' },
  'pos.custForPoints': { key: 'pos.custForPoints', en: 'Select a customer — to redeem points', roman: 'Customer select karein — points redeem ke liye', ur: 'کسٹمر منتخب کریں — پوائنٹس ریڈیم کرنے کے لیے' },
  'pos.currentDue': { key: 'pos.currentDue', en: 'Current due (credit) ', roman: 'Current Due (udhaar) ', ur: 'موجودہ بقایا (ادھار) ' },
  'pos.billCreditTail': { key: 'pos.billCreditTail', en: ', this bill credit ', roman: ', is bill ka udhaar ', ur: ', اس بل کا ادھار ' },
  'pos.creditTail': { key: 'pos.creditTail', en: ', credit ', roman: ', udhaar ', ur: ', ادھار ' },
  'pos.payOptionsTail': { key: 'pos.payOptionsTail', en: ' (pay via Cash or Card, or select Credit)', roman: ' (Cash ya Card se pay karein, ya Udhaar select karein)', ur: ' (کیش یا کارڈ سے ادا کریں، یا ادھار منتخب کریں)' },
  'pos.clearCartConfirm': { key: 'pos.clearCartConfirm', en: 'Clear cart? This removes all items from the bill.', roman: 'Cart clear karein? Ye bill ke saare items hata dega.', ur: 'کارٹ خالی کریں؟ یہ بل کے تمام آئٹمز ہٹا دے گا۔' },
  'pos.searchInAddItems': { key: 'pos.searchInAddItems', en: ' — search in Add items', roman: ' — Add items me search karein', ur: ' — Add items میں تلاش کریں' },
  'pos.typeBarcode': { key: 'pos.typeBarcode', en: 'Type barcode/QR code', roman: 'Barcode/QR code type karein', ur: 'بارکوڈ/کیو آر کوڈ ٹائپ کریں' },
  'pos.shortcutsNote': { key: 'pos.shortcutsNote', en: 'All shortcuts work only on the POS screen. F-keys are ignored while typing (except Esc/F9).', roman: 'Sab shortcuts sirf POS screen par kaam karte hain. Typing ke dauran F-keys nahi chalte (except Esc/F9).', ur: 'تمام شارٹ کٹس صرف پی او ایس اسکرین پر کام کرتے ہیں۔ ٹائپنگ کے دوران F-keys نہیں چلتے (except Esc/F9)۔' },
  'pos.scF3F4': { key: 'pos.scF3F4', en: 'F3 or F4 — pick customer', roman: 'F3 ya F4 — Customer chunein', ur: 'F3 یا F4 — کسٹمر چنیں' },
  'pos.scF8': { key: 'pos.scF8', en: 'F8 — hold bill (pending)', roman: 'F8 — Bill hold karein (pending)', ur: 'F8 — بل ہول کریں (زیرِ التوا)' },
  'pos.scCtrlK': { key: 'pos.scCtrlK', en: 'Ctrl+K — command palette, Esc — close', roman: 'Ctrl+K — Command palette, Esc — Band karein', ur: 'Ctrl+K — کمانڈ پیلیٹ، Esc — بند کریں' },
  'sc2.noPo': { key: 'sc2.noPo', en: 'No POs', roman: 'Koi PO nahi', ur: 'کوئی پی او نہیں' },
  'sc2.noGrn': { key: 'sc2.noGrn', en: 'No GRNs', roman: 'Koi GRN nahi', ur: 'کوئی جی آر این نہیں' },
  'sc2.codeNotFound': { key: 'sc2.codeNotFound', en: 'Code not found: ', roman: 'Code nahi mila: ', ur: 'کوڈ نہیں ملا: ' },
  'sc2.prevPayable': { key: 'sc2.prevPayable', en: 'Previous balance (payable)', roman: 'Pichhla baqaya (previous payable)', ur: 'پچھلا بقایا (ادائیگی کے لیے)' },
  'sc2.noLineItems': { key: 'sc2.noLineItems', en: 'No line items', roman: 'Koi line item nahi', ur: 'کوئی لائن آئٹم نہیں' },
  'sc2.openSupplier': { key: 'sc2.openSupplier', en: 'Open supplier record', roman: 'Supplier record kholein', ur: 'سپلائر ریکارڈ کھولیں' },
  'sc2.noItemsScan': { key: 'sc2.noItemsScan', en: 'No items — add via scan or search', roman: 'Koi item nahi — scan ya search se add karein', ur: 'کوئی آئٹم نہیں — اسکین یا تلاش سے شامل کریں' },
  'sc2.scanLineHint': { key: 'sc2.scanLineHint', en: 'Scan → line (qty merge) · edit qty in the table', roman: 'Scan → line (qty merge) · qty badalne ke liye table mein edit karein', ur: 'اسکین → لائن (qty ضم) · qty ٹیبل میں تبدیل کریں' },
  'sc2.needOneItem': { key: 'sc2.needOneItem', en: 'Add at least one item', roman: 'Kam az kam ek item add karein', ur: 'کم از کم ایک آئٹم شامل کریں' },
  'sc2.selectSupplier': { key: 'sc2.selectSupplier', en: 'Select a supplier', roman: 'Supplier select karein', ur: 'سپلائر منتخب کریں' },
  'sc2.returnSaveFail': { key: 'sc2.returnSaveFail', en: 'Return could not be saved', roman: 'Return save nahi hua', ur: 'واپسی محفوظ نہیں ہوئی' },
  'sc2.newProductCat': { key: 'sc2.newProductCat', en: 'New product not in catalog — manual entry', roman: 'Naya product jo catalog mein nahi — manual entry', ur: 'نیا پروڈکٹ کیٹلاگ میں نہیں — دستی اندراج' },
  'sc2.prevRateNone': { key: 'sc2.prevRateNone', en: 'Previous rate: no record', roman: 'Pichhli rate: record nahi', ur: 'پچھلی ریٹ: ریکارڈ نہیں' },
  'sc2.addItems': { key: 'sc2.addItems', en: 'Add items', roman: 'Items add karein', ur: 'آئٹمز شامل کریں' },
  'sc2.onCredit': { key: 'sc2.onCredit', en: 'On credit (supplier credit)', roman: 'On credit (supplier udhaar)', ur: 'ادھار (سپلائر کریڈٹ)' },
  'sc2.offCashPurchase': { key: 'sc2.offCashPurchase', en: 'Off = cash purchase (supplier balance will not increase)', roman: 'Off = cash purchase (supplier ka balance nahi barhega)', ur: 'آف = کیش خریداری (سپلائر بیلنس نہیں بڑھے گا)' },
  'sc2.loadPendingLines': { key: 'sc2.loadPendingLines', en: 'Load pending lines of any open PO here', roman: 'Kisi bhi open PO ki pending lines yahan load karein', ur: 'کسی بھی کھلے پی او کی زیرِ التوا لائنیں یہاں لوڈ کریں' },
  'sc2.noOpenPo': { key: 'sc2.noOpenPo', en: 'No open POs', roman: 'Koi open PO nahi', ur: 'کوئی کھلا پی او نہیں' },
  'sc2.newProductStore': { key: 'sc2.newProductStore', en: 'New product not in store — manual entry', roman: 'Naya product jo store mein nahi — manual entry', ur: 'نیا پروڈکٹ اسٹور میں نہیں — دستی اندراج' },
  'sc2.addToTotal': { key: 'sc2.addToTotal', en: 'Will be added to total (per supplier bill)', roman: 'Total mein jud jayega (supplier bill ke mutabiq)', ur: 'ٹوٹل میں شامل ہو گا (سپلائر بل کے مطابق)' },
  'sc2.noLinesYet': { key: 'sc2.noLinesYet', en: 'No lines yet', roman: 'Abhi koi line nahi', ur: 'ابھی کوئی لائن نہیں' },
  'sc2.waitingPo': { key: 'sc2.waitingPo', en: 'Waiting for PO to load… or add items via scan/search', roman: 'PO load hone ka intezar… ya scan/search se items add karein', ur: 'پی او لوڈ ہونے کا انتظار… یا اسکین/تلاش سے آئٹمز شامل کریں' },
  'sc2.scanOrList': { key: 'sc2.scanOrList', en: 'Scan, or add items from the 📋 full list', roman: 'Scan karein ya 📋 poori list se items add karein', ur: 'اسکین کریں یا 📋 مکمل فہرست سے آئٹمز شامل کریں' },
  'sc2.addItemsFirst': { key: 'sc2.addItemsFirst', en: 'Add items first (scan or full list)', roman: 'Pehle items add karein (scan ya poori list se)', ur: 'پہلے آئٹمز شامل کریں (اسکین یا مکمل فہرست سے)' },
  'sc2.qtyZero': { key: 'sc2.qtyZero', en: ' line(s) have qty 0 — fix them', roman: ' line(s) ki qty 0 hai — theek karein', ur: ' لائن(وں) کی qty 0 ہے — درست کریں' },
  'sc2.creditNeedsSupplier': { key: 'sc2.creditNeedsSupplier', en: 'Select a supplier for credit purchase', roman: 'Credit purchase ke liye supplier chunein', ur: 'کریڈٹ خریداری کے لیے سپلائر منتخب کریں' },
  'sc2.poHint': { key: 'sc2.poHint', en: 'Pick a PO and its pending lines load automatically. No PO = direct purchase.', roman: 'PO chunein to uski pending lines khud aa jayengi. Bina PO = direct purchase.', ur: 'پی او منتخب کریں تو اس کی زیرِ التوا لائنیں خود آ جائیں گی۔ بغیر پی او = براہِ راست خریداری۔' },
  'sc2.scannerHint': { key: 'sc2.scannerHint', en: 'Scan with a scanner (like POS): Found → Added → field cleared. Or multi-select from the 📋 list.', roman: 'Scanner se scan karein (POS jaisa): Found → Added → field khali. Ya 📋 list se multi-select.', ur: 'اسکینر سے اسکین کریں (پی او ایس جیسا): مل گیا → شامل → فیلڈ خالی۔ یا 📋 فہرست سے ملٹی سلیکٹ۔' },
  'sc2.noEntries': { key: 'sc2.noEntries', en: 'No entries', roman: 'Koi entry nahi', ur: 'کوئی انٹری نہیں' },
  'sc2.openingUdhaar': { key: 'sc2.openingUdhaar', en: 'Opening credit', roman: 'Opening udhaar', ur: 'افتتاحی ادھار' },
  'sc2.noPayments': { key: 'sc2.noPayments', en: 'No payments', roman: 'Koi payment nahi', ur: 'کوئی ادائیگی نہیں' },
  'sc2.noExpenses': { key: 'sc2.noExpenses', en: 'No expenses', roman: 'Koi kharcha nahi', ur: 'کوئی خرچ نہیں' },
  'sc2.noCashSession': { key: 'sc2.noCashSession', en: 'No open cash session', roman: 'Koi open cash session nahi', ur: 'کوئی کھلا کیش سیشن نہیں' },
  'sc2.countAtClose': { key: 'sc2.countAtClose', en: 'Count at closing time', roman: 'Closing ke waqt count karein', ur: 'بند کرنے کے وقت گنتی کریں' },
  'sc2.printFail': { key: 'sc2.printFail', en: 'Could not print', roman: 'Print nahi ho saka', ur: 'پرنٹ نہیں ہو سکا' },
  'sc2.pdfFail': { key: 'sc2.pdfFail', en: 'Could not create PDF', roman: 'PDF nahi ban saki', ur: 'پی ڈی ایف نہیں بن سکی' },
  'sc2.copyFail': { key: 'sc2.copyFail', en: 'Could not copy', roman: 'Copy nahi ban saki', ur: 'کاپی نہیں بن سکی' },
  'sc2.shareFail': { key: 'sc2.shareFail', en: 'Could not share', roman: 'Share nahi ho saka', ur: 'شیئر نہیں ہو سکا' },
  'sc2.dashAll': { key: 'sc2.dashAll', en: 'Sales, profit, stock, credit — everything', roman: 'Sales, profit, stock, udhaar — sab kuch', ur: 'سیل، منافع، اسٹاک، ادھار — سب کچھ' },
  'sc2.receivables': { key: 'sc2.receivables', en: 'Receivables (credit)', roman: 'Receivables (udhaar)', ur: 'وصولی (ادھار)' },
  'sc2.offlineReport': { key: 'sc2.offlineReport', en: 'Offline — report data unavailable', roman: 'Offline — report data maujood nahi', ur: 'آف لائن — رپورٹ ڈیٹا موجود نہیں' },
  'sc2.reportCatFail': { key: 'sc2.reportCatFail', en: 'Report catalog failed to load', roman: 'Report catalog load nahi hua', ur: 'رپورٹ کیٹلاگ لوڈ نہیں ہوا' },
  'sc2.prevBalPrev': { key: 'sc2.prevBalPrev', en: 'Previous balance (prev)', roman: 'Pichhla baqaya (prev)', ur: 'پچھلا بقایا (سابقہ)' },
  'sc2.newUdhaar': { key: 'sc2.newUdhaar', en: 'New credit', roman: 'Naya udhaar', ur: 'نیا ادھار' },
  'sc2.collections': { key: 'sc2.collections', en: 'Collections', roman: 'Wasooli', ur: 'وصولی' },
  'sc2.totalUdhaarClose': { key: 'sc2.totalUdhaarClose', en: 'Total credit (closing)', roman: 'Total udhaar (closing)', ur: 'کل ادھار (اختتام)' },
  'sc2.customerUdhaar': { key: 'sc2.customerUdhaar', en: 'Customer-wise credit', roman: 'Customer-wise udhaar', ur: 'کسٹمر کے حساب ادھار' },
  'sc2.prevBal': { key: 'sc2.prevBal', en: 'Previous balance', roman: 'Pichhla baqaya', ur: 'پچھلا بقایا' },
  'sc2.permHint': { key: 'sc2.permHint', en: 'To grant or deny extra fields to a user/group, use the extra & denied permissions in the Users / Groups tab. ', roman: 'Kisi user/group ko extra ya denied fields dene ke liye Users / Groups tab ke extra & denied permissions istemal karein. ', ur: 'کسی یوزر/گروپ کو اضافی یا مسترد فیلڈز دینے کے لیے یوزرز / گروپس ٹیب کی extra & denied اجازتیں استعمال کریں۔ ' },
  'sc2.permsLoadFail': { key: 'sc2.permsLoadFail', en: '⚠ Permissions failed to load', roman: '⚠ Permissions load nahi hui', ur: '⚠ اجازتیں لوڈ نہیں ہوئیں' },
  'sc2.noLogs': { key: 'sc2.noLogs', en: 'No logs', roman: 'Koi log nahi', ur: 'کوئی لاگ نہیں' },
  'sc2.resetPermsConfirm': { key: 'sc2.resetPermsConfirm', en: 'Reset all roles to default permissions?', roman: 'Saare roles ko default permissions par wapas karein?', ur: 'تمام رولز ڈیفالٹ اجازتوں پر واپس کریں؟' },
  'sc2.roleSaveFail': { key: 'sc2.roleSaveFail', en: ' role could not be saved — ', roman: ' role save nahi ho sake — ', ur: ' رول محفوظ نہیں ہو سکا — ' },
  'sc2.permCatFail': { key: 'sc2.permCatFail', en: 'Permission catalog failed to load', roman: 'Permission catalog load nahi hua', ur: 'اجازت کیٹلاگ لوڈ نہیں ہوا' },
  'sc2.noBranches': { key: 'sc2.noBranches', en: 'No branches defined', roman: 'Koi branch defined nahi', ur: 'کوئی برانچ متعین نہیں' },
  'sc2.permMatrixHint': { key: 'sc2.permMatrixHint', en: 'Beyond the role, “Allow” grants an extra permission, “Deny” blocks it. Click a row to cycle Inherit → Allow → Deny.', roman: 'Role ke baad “Allow” extra permission deta hai, “Deny” usay block kar deta hai. Har row par click karke Inherit → Allow → Deny badal dein.', ur: 'رول کے بعد “Allow” اضافی اجازت دیتا ہے، “Deny” اسے روکتا ہے۔ کسی قطار پر کلک کر کے Inherit → Allow → Deny بدلیں۔' },
  'sc2.labelsFail': { key: 'sc2.labelsFail', en: 'Labels failed: ', roman: 'Labels fail: ', ur: 'لیبلز ناکام: ' },
  'sc2.prPosted': { key: 'sc2.prPosted', en: 'Purchase return posted ✅', roman: 'Purchase return post ho gaya ✅', ur: 'خریداری واپسی درج ہو گئی ✅' },
  'sc2.newCopy': { key: 'sc2.newCopy', en: 'New copy added to list', roman: 'Nayi copy list mein hai', ur: 'نئی کاپی فہرست میں ہے' },
  'sc2.poAllReceived': { key: 'sc2.poAllReceived', en: 'All lines of this PO already received', roman: 'Is PO ki saari lines receive ho chuki hain', ur: 'اس پی او کی تمام لائنیں موصول ہو چکی ہیں' },
  'sc2.productNameReq': { key: 'sc2.productNameReq', en: 'Product name is required', roman: 'Product name zaruri hai', ur: 'پروڈکٹ کا نام ضروری ہے' },
  'sc2.customAdded': { key: 'sc2.customAdded', en: 'Custom item added', roman: 'Custom item add ho gaya', ur: 'کسٹم آئٹم شامل ہو گیا' },
  'sc2.loadPoFirst': { key: 'sc2.loadPoFirst', en: 'Load a PO first or add items', roman: 'Pehle PO load karein ya items add karein', ur: 'پہلے پی او لوڈ کریں یا آئٹمز شامل کریں' },
  'sc2.grnPosted': { key: 'sc2.grnPosted', en: 'GRN posted — stock updated', roman: 'GRN posted — stock update ho gaya', ur: 'جی آر این درج — اسٹاک اپ ڈیٹ ہو گیا' },
  'sc2.nameReq': { key: 'sc2.nameReq', en: 'Name is required', roman: 'Name zaroori hai', ur: 'نام ضروری ہے' },
  'sc2.popupBlocked': { key: 'sc2.popupBlocked', en: 'Popup blocked — allow popups to print', roman: 'Popup blocked — print ke liye popups allow karein', ur: 'پاپ اپ بلاک — پرنٹ کے لیے پاپ اپس کی اجازت دیں' },
  'sc2.pdfDone': { key: 'sc2.pdfDone', en: 'PDF created', roman: 'PDF ban gayi', ur: 'پی ڈی ایف بن گئی' },
  'sc2.copyDone': { key: 'sc2.copyDone', en: 'Copy created: ', roman: 'Copy ban gayi: ', ur: 'کاپی بن گئی: ' },
  'sc2.noPerm': { key: 'sc2.noPerm', en: 'Permission denied', roman: 'Permission nahi', ur: 'اجازت نہیں' },
  'sc2.defaultsRestored': { key: 'sc2.defaultsRestored', en: 'Defaults restored (save to keep)', roman: 'Defaults restore ho gaye (save karein)', ur: 'ڈیفالٹس بحال ہو گئے (محفوظ کریں)' },
  ...
  'ui2.rowOpenTitle': { key: 'ui2.rowOpenTitle', en: ' — open record (context is saved)', roman: ' — record kholein (context save hota hai)', ur: ' — ریکارڈ کھولیں (سیاق محفوظ رہتا ہے)' },
  'ui2.rowOpenAria': { key: 'ui2.rowOpenAria', en: ' open', roman: ' kholein', ur: ' کھولیں' },
  'ui2.stockLimit': { key: 'ui2.stockLimit', en: 'Stock limit: ', roman: 'Stock limit: ', ur: 'اسٹاک حد: ' },
  'ui2.stockLimitTail': { key: 'ui2.stockLimitTail', en: ' — cannot add more', roman: ' se zyada add nahi', ur: ' — مزید شامل نہیں ہو سکتا' },
  'ui2.codeNotFound': { key: 'ui2.codeNotFound', en: 'Code not found: ', roman: 'Code nahi mila: ', ur: 'کوڈ نہیں ملا: ' },
  'ui2.codeNotFoundTail': { key: 'ui2.codeNotFoundTail', en: ' — field cleared, next scan ready', roman: ' — field clear, next scan ready', ur: ' — فیلڈ صاف، اگلا اسکین تیار' },
  'ui2.notFound': { key: 'ui2.notFound', en: 'not found', roman: 'nahi mila', ur: 'نہیں ملا' },
  'ui2.dec': { key: 'ui2.dec', en: 'Decrease', roman: 'Kam karein', ur: 'کم کریں' },
  'ui2.addClick': { key: 'ui2.addClick', en: 'Click to add', roman: 'Add karne ke liye click karein', ur: 'شامل کرنے کے لیے کلک کریں' },
  'ui2.ipkNoHit': { key: 'ui2.ipkNoHit', en: 'No item found — check the code or scan again', roman: 'Koi item nahi mila — code check karein ya naya scan karein', ur: 'کوئی آئٹم نہیں ملا — کوڈ چیک کریں یا دوبارہ اسکین کریں' },
  'ui2.ipkNoItems': { key: 'ui2.ipkNoItems', en: 'No items', roman: 'Koi item nahi', ur: 'کوئی آئٹم نہیں' },
  'ui2.scanNoCam': { key: 'ui2.scanNoCam', en: 'Camera scan not available — type or paste the code (Enter = OK).', roman: 'Camera scan available nahi — code type ya paste karein (Enter = OK).', ur: 'کیمرہ اسکین دستیاب نہیں — کوڈ ٹائپ یا پیسٹ کریں (Enter = OK)۔' },
  'ui2.copyNoAuto': { key: 'ui2.copyNoAuto', en: 'Automatic copy not available — select and copy below (Ctrl+C).', roman: 'Automatic copy available nahi — neeche se select karke copy karein (Ctrl+C).', ur: 'خودکار کاپی دستیاب نہیں — نیچے سے منتخب کر کے کاپی کریں (Ctrl+C)۔' },
  'ui2.copied': { key: 'ui2.copied', en: 'copied', roman: 'copy ho gaya', ur: 'کاپی ہو گیا' },
  'ui2.viewsBtn': { key: 'ui2.viewsBtn', en: 'Save/load filter presets', roman: 'Filter presets save/load karein', ur: 'فلٹر پری سیٹ محفوظ/لوڈ کریں' },
  'ui2.viewLoadFail': { key: 'ui2.viewLoadFail', en: 'View failed to load', roman: 'View load nahi hua', ur: 'ویو لوڈ نہیں ہوئی' },
  'ui2.noViews': { key: 'ui2.noViews', en: 'No saved views yet', roman: 'Abhi koi saved view nahi', ur: 'ابھی کوئی محفوظ ویو نہیں' },
  'ui2.viewsLoadFail': { key: 'ui2.viewsLoadFail', en: 'Views failed to load', roman: 'Views load nahi hue', ur: 'ویوز لوڈ نہیں ہوئیں' },
  'ui2.loadFail': { key: 'ui2.loadFail', en: 'Failed to load: ', roman: 'Load nahi hua: ', ur: 'لوڈ نہیں ہوا: ' },
  'ui2.filterNoHit': { key: 'ui2.filterNoHit', en: 'Nothing matches this filter', roman: 'Is filter se kuch nahi mila', ur: 'اس فلٹر سے کچھ نہیں ملا' },
  'ui2.noData': { key: 'ui2.noData', en: 'No data', roman: 'Koi data nahi', ur: 'کوئی ڈیٹا نہیں' },
  'ui2.srEmpty': { key: 'ui2.srEmpty', en: 'Nothing found — type again to retry', roman: 'Kuch nahi mila — dobara likh kar try karein', ur: 'کچھ نہیں ملا — دوبارہ لکھ کر کوشش کریں' },
  'ui2.scanHit': { key: 'ui2.scanHit', en: 'Scan found: ', roman: 'Scan mil gaya: ', ur: 'اسکین مل گیا: ' },
  'ui2.pickFromList': { key: 'ui2.pickFromList', en: 'select from the list', roman: 'list se select karein', ur: 'فہرست سے منتخب کریں' },
  'ui2.imgBig': { key: 'ui2.imgBig', en: 'Image is over 6MB — shrink it and try again', roman: 'Image 6MB se bari hai — chhoti kar ke try karein', ur: 'تصویر 6MB سے بڑی ہے — چھوٹی کر کے کوشش کریں' },
  'ui2.imgRemoved': { key: 'ui2.imgRemoved', en: 'Image removed — Save to remove it permanently', roman: 'Image hata di — Save karein to remove ho jayegi', ur: 'تصویر ہٹا دی — محفوظ کریں تو ہمیشہ کے لیے ہٹ جائے گی' },
  'ui2.imgRemoveBtn': { key: 'ui2.imgRemoveBtn', en: '✕ Remove', roman: '✕ Hataein', ur: '✕ ہٹائیں' },
  'ui2.choose': { key: 'ui2.choose', en: '— choose —', roman: '— chunein —', ur: '— منتخب کریں —' },
  'ui2.saBusy': { key: 'ui2.saBusy', en: 'SAVE ALL is already running — please wait', roman: 'SAVE ALL pehle se chal raha hai — intezar karein', ur: 'SAVE ALL پہلے سے چل رہا ہے — انتظار کریں' },
  'ui2.saNone': { key: 'ui2.saNone', en: 'No unsaved changes — everything is saved', roman: 'Koi unsaved tabdeeli nahi — sab mehfooz hai', ur: 'کوئی غیر محفوظ تبدیلی نہیں — سب محفوظ ہے' },
  'ui2.saNa': { key: 'ui2.saNa', en: 'SAVE ALL is not available on this page — use the page Save button', roman: 'Is page par SAVE ALL available nahi — apne Save button se save karein', ur: 'اس صفحے پر SAVE ALL دستیاب نہیں — اپنے Save بٹن سے محفوظ کریں' },
  'ui2.saDone': { key: 'ui2.saDone', en: 'change(s) saved (', roman: 'tabdeeli save ho gayi (', ur: 'تبدیلیاں محفوظ ہو گئیں (' },
  'ui2.saDoneTail': { key: 'ui2.saDoneTail', en: 'section)', roman: 'section)', ur: 'سیکشن)' },
  'ui2.fixField': { key: 'ui2.fixField', en: 'Fix this field', roman: 'Ye field durust karein', ur: 'یہ فیلڈ درست کریں' },
  'ui2.nothingFound': { key: 'ui2.nothingFound', en: 'Nothing found', roman: 'Kuch nahi mila', ur: 'کچھ نہیں ملا' },
  'ui2.docsOverview': { key: 'ui2.docsOverview', en: 'What this app does — module tour', roman: 'Ye app kya karta hai — modules ka jaiza', ur: 'یہ ایپ کیا کرتی ہے — ماڈیولز کا جائزہ' },
  'ui2.close': { key: 'ui2.close', en: 'Close', roman: 'Band karein', ur: 'بند کریں' },
  'ui2.fileReadFail': { key: 'ui2.fileReadFail', en: 'Could not read file', roman: 'File nahi parh sake', ur: 'فائل پڑھ نہیں سکے' },
  'ui2.imgInvalid': { key: 'ui2.imgInvalid', en: 'Not a valid image', roman: 'Ye valid image nahi hai', ur: 'یہ درست تصویر نہیں ہے' },
  'ui2.pickerFail': { key: 'ui2.pickerFail', en: 'Product picker failed to load', roman: 'Product picker load nahi hua', ur: 'پروڈکٹ پکر لوڈ نہیں ہوا' },
  'ui2.bulkHint': { key: 'ui2.bulkHint', en: 'Scan → Bulk List → Add All · or tick via search/📋 list', roman: 'Scan → Bulk List → Add All · ya search/📋 list se tick karein', ur: 'اسکین → بلک لسٹ → ایڈ آل · یا سرچ/📋 لسٹ سے ٹک کریں' },
  'ui2.bulkSub': { key: 'ui2.bulkSub', en: 'Scan → adds straight to Bulk List → field cleared · or tick → Add All', roman: 'Scan → Bulk List mein foran add → field khali · ya tick karein → Add All', ur: 'اسکین → بلک لسٹ میں فوراً ایڈ → فیلڈ خالی · یا ٹک → ایڈ آل' },
  'sm.selAria': { key: 'sm.selAria', en: 'Salesman — select a salesman', roman: 'Salesman — salesman select karein', ur: 'سیلز مین — سیلز مین منتخب کریں' },
  'sm.selTitle': { key: 'sm.selTitle', en: 'Select salesman', roman: 'Salesman select karein', ur: 'سیلز مین منتخب کریں' },
  'sm.selOpt': { key: 'sm.selOpt', en: '— Select a salesman —', roman: '— Salesman select karein —', ur: '— سیلز مین منتخب کریں —' },
  'sm.needTitle': { key: 'sm.needTitle', en: '👤 Select a salesman to continue', roman: '👤 Salesman select karna zaruri hai', ur: '👤 جاری رکھنے کے لیے سیلز مین منتخب کریں' },
  'sm.needBody': { key: 'sm.needBody', en: 'Select a salesman above — then every tab (Issued / Stock / Tours / Ledger …) will show its data.', roman: 'Pehle upar se salesman choose karein — phir har tab (Issued / Stock / Tours / Ledger …) ka data nazar aayega.', ur: 'اوپر سے سیلز مین منتخب کریں — پھر ہر ٹیب (جاری / اسٹاک / دورے / لیجر …) کا ڈیٹا نظر آئے گا۔' },
  'sm.chooseBtn': { key: 'sm.chooseBtn', en: 'Choose a salesman →', roman: 'Salesman choose karein →', ur: 'سیلز مین منتخب کریں →' },
  'sm.addItems': { key: 'sm.addItems', en: 'Add items — search above, set qty/cost', roman: 'Items add karein — search upar + qty/cost set karein', ur: 'آئٹمز شامل کریں — اوپر سرچ کریں + qty/cost سیٹ کریں' },
  'sm.issueSub': { key: 'sm.issueSub', en: 'Details + items in one place · scan or add via 📋 list · F9 = Issue (F2 = scan field)', roman: 'Details + items ek hi jagah · scan karein ya 📋 list se add karein · F9 = Issue (F2 = scan field)', ur: 'تفصیلات + آئٹمز ایک جگہ · اسکین کریں یا 📋 لسٹ سے شامل کریں · F9 = اجرا (F2 = اسکین فیلڈ)' },
  'sm.addFirst': { key: 'sm.addFirst', en: 'Add items first (scan or 📋 list)', roman: 'Pehle items add karein (scan ya 📋 list se)', ur: 'پہلے آئٹمز شامل کریں (اسکین یا 📋 لسٹ سے)' },
  'sm.zeroQty': { key: 'sm.zeroQty', en: 'line(s) have qty 0 — fix them', roman: 'line ki qty 0 hai — theek karein', ur: 'لائن کی qty 0 ہے — درست کریں' },
  'sm.issued': { key: 'sm.issued', en: 'Issue done ✅', roman: 'Issue ho gaya ✅', ur: 'اجرا مکمل ✅' },
  'sm.kpiOut': { key: 'sm.kpiOut', en: 'Show out-of-stock items only', roman: 'Sirf out-of-stock items dikhayein', ur: 'صرف آؤٹ آف اسٹاک آئٹمز دکھائیں' },
  'sm.kpiLow': { key: 'sm.kpiLow', en: 'Show low-stock (<5) items only', roman: 'Sirf low stock (<5) items dikhayein', ur: 'صرف کم اسٹاک (<5) آئٹمز دکھائیں' },
  'sm.filterEmpty': { key: 'sm.filterEmpty', en: 'Nothing matches this filter', roman: 'Is filter par kuch nahi mila', ur: 'اس فلٹر پر کچھ نہیں ملا' },
  'sm.filterHint': { key: 'sm.filterHint', en: 'Clear the search or tap the "Out of stock / Low" KPI again.', roman: 'Search khali karein ya "Out of stock / Low" KPI dobara dabayein.', ur: 'سرچ خالی کریں یا "Out of stock / Low" KPI دوبارہ دبائیں۔' },
  'sm.filterClear': { key: 'sm.filterClear', en: '✕ Clear filter', roman: '✕ Filter clear karein', ur: '✕ فلٹر صاف کریں' },
  'sm.noStock': { key: 'sm.noStock', en: 'No stock issued to this salesman yet — create one from the Stock Issued tab.', roman: 'Is salesman ko abhi koi stock issue nahi hua — Stock Issued tab se naya issue banayein.', ur: 'اس سیلز مین کو ابھی کوئی اسٹاک جاری نہیں ہوا — Stock Issued ٹیب سے نیا اجرا بنائیں۔' },
  'sm.notWithSm': { key: 'sm.notWithSm', en: 'Not with this salesman: ', roman: 'Is salesman ke paas nahi: ', ur: 'اس سیلز مین کے پاس نہیں: ' },
  'sm.selSalesman': { key: 'sm.selSalesman', en: 'Select a salesman', roman: 'Salesman select karein', ur: 'سیلز مین منتخب کریں' },
  'sm.noAlloc': { key: 'sm.noAlloc', en: 'No issued stock — first create an issue with tour/area/customer from Stock Issued.', roman: 'Issue nahi mila — pehle Stock Issued se tour/area/customer ke sath issue banayein.', ur: 'جاری اسٹاک نہیں ملا — پہلے Stock Issued سے دورہ/علاقہ/کسٹمر کے ساتھ اجرا بنائیں۔' },
  'sm.noCustTag': { key: 'sm.noCustTag', en: 'No customer-tagged issues — choose a customer on the next issue.', roman: 'Customer ke naam se issue nahi hua — next issue me customer choose karein.', ur: 'کسٹمر کے نام سے اجرا نہیں ہوا — اگلی اجرا میں کسٹمر منتخب کریں۔' },
  'sm.noRouteTag': { key: 'sm.noRouteTag', en: 'No route-tagged issues — create a route in the Tours tab.', roman: 'Route/tour ke sath issue nahi — Tours tab me route banayein.', ur: 'روٹ/دورہ کے ساتھ اجرا نہیں — Tours ٹیب میں روٹ بنائیں۔' },
  'sm.noAreaTag': { key: 'sm.noAreaTag', en: 'Write an area on the issue and it will show here.', roman: 'Area likh kar issue karein to yahan nazar aayega.', ur: 'اجرے پر علاقہ لکھیں تو یہاں نظر آئے گا۔' },
  'sm.noSales': { key: 'sm.noSales', en: 'No sales for this salesman yet — sell via POS or order via PWA Field.', roman: 'Is salesman ki koi sale nahi — POS se sale karein ya PWA Field se order banayein.', ur: 'اس سیلز مین کی کوئی سیل نہیں — POS سے سیل کریں یا PWA Field سے آرڈر بنائیں۔' },
  'sm.noVisits': { key: 'sm.noVisits', en: 'No visits logged — visits log from PWA Field or Collections.', roman: 'Tour/visit koi record nahi — PWA Field ya Wasooli se visit log hota hai.', ur: 'دورہ/وزٹ کا کوئی ریکارڈ نہیں — PWA Field یا وصولی سے وزٹ لاگ ہوتا ہے۔' },
  'sm.noReturns': { key: 'sm.noReturns', en: 'No returns yet — leftover stock returning from the salesman will appear here.', roman: 'Koi wapsi nahi hui — jab salesman ke paas bacha stock wapas aayega to yahan nazar aayega.', ur: 'ابھی کوئی واپسی نہیں — سیلز مین کے پاس بچا اسٹاک واپس آئے گا تو یہاں نظر آئے گا۔' },
  'sm.segPayTitle': { key: 'sm.segPayTitle', en: 'Collection payments only', roman: 'Wasooli payments only', ur: 'صرف وصولی ادائیگیاں' },
  'sm.segPay': { key: 'sm.segPay', en: '💵 Collections', roman: '💵 Wasooli Payments', ur: '💵 وصولیاں' },
  'sm.ledgerHint': { key: 'sm.ledgerHint', en: 'Ledger joins every issue / sale / return / collection into one timeline — search + date filter make reconciliation easy.', roman: 'Ledger har issue / sale / return / wasooli ko ek timeline me jorta hai — search + date filter se reconciliation aasaan.', ur: 'لیجر ہر اجرا / سیل / واپسی / وصولی کو ایک ٹائم لائن میں جوڑتا ہے — سرچ + تاریخ فلٹر سے ریکانسیلیشن آسان۔' },
  'sm.recCollTitle': { key: 'sm.recCollTitle', en: 'Record a collection (ledger auto-updates)', roman: 'Record udhar wasooli (ledger auto-update)', ur: 'وصولی درج کریں (لیجر خود بخود اپڈیٹ)' },
  'sm.noColl': { key: 'sm.noColl', en: 'No collection payments — use “Record Collection” to add one', roman: 'No collection payments — use “Record Collection” to add Wasooli', ur: 'کوئی وصولی ادائیگیاں نہیں — “Record Collection” سے شامل کریں' },
  'sm.collTitle': { key: 'sm.collTitle', en: '💵 Credit Collection — Record Collection (ledger auto-update)', roman: '💵 Udhar Wasooli — Record Collection (ledger auto-update)', ur: '💵 ادھار وصولی — ریکارڈ کلیکشن (لیجر خود بخود اپڈیٹ)' },
  'sm.selCustomer': { key: 'sm.selCustomer', en: 'Select a customer', roman: 'Customer select karein', ur: 'کسٹمر منتخب کریں' },
  'sm.perfTail': { key: 'sm.perfTail', en: 'compare via the period filter.', roman: 'period filter se compare karein.', ur: 'پیریڈ فلٹر سے موازنہ کریں۔' },
  'sm.noPerf': { key: 'sm.noPerf', en: 'No performance data — issue or sell first', roman: 'No performance data — issue/sale karein', ur: 'کوئی پرفارمنس ڈیٹا نہیں — پہلے اجرا یا سیل کریں' },
  'dm.none': { key: 'dm.none', en: 'No demands found', roman: 'Koi demand nahi mili', ur: 'کوئی ڈیمانڈ نہیں ملی' },
  'dm.noPo': { key: 'dm.noPo', en: 'No PO linked — sourcing pending', roman: 'Koi PO link nahi — sourcing pending', ur: 'کوئی PO لنک نہیں — سورسنگ زیرِ التوا' },
  'dm.cancelAsk': { key: 'dm.cancelAsk', en: ' — cancel it? Stock/PO are not affected; only the demand closes.', roman: ' cancel karein? Stock/PO par asar nahi hoga, sirf demand band ho gi.', ur: ' — منسوخ کریں؟ اسٹاک/PO متاثر نہیں ہوں گے، صرف ڈیمانڈ بند ہو گی۔' },
  'dm.statusUp': { key: 'dm.statusUp', en: 'updated', roman: 'update ho gaya', ur: 'اپڈیٹ ہو گیا' },
  'dm.pickCust': { key: 'dm.pickCust', en: 'Pick from the customer list — balance, credit limit and open demands appear here instantly.', roman: 'Customer list se select karein — balance, credit limit aur open demands foran yahan aa jayengi.', ur: 'کسٹمر لسٹ سے منتخب کریں — بیلنس، کریڈٹ حد اور کھلے ڈیمانڈز فوراً یہاں آ جائیں گے۔' },
  'dm.pickProd': { key: 'dm.pickProd', en: 'Pick a product — current stock, price and past-demand summary included.', roman: 'Product pick karein — current stock, price aur pichhli demands ka summary milega.', ur: 'پروڈکٹ منتخب کریں — موجودہ اسٹاک، قیمت اور پچھلے ڈیمانڈز کا خلاصہ ملے گا۔' },
  'dm.newCust': { key: 'dm.newCust', en: 'No customer selected — on Save, a new customer record is created from name + phone.', roman: 'Customer list se select nahi kiya — Save par naam + phone se naya customer record khud ban jayega.', ur: 'کسٹمر منتخب نہیں کیا — Save پر نام + فون سے نیا کسٹمر ریکارڈ خود بن جائے گا۔' },
  'dm.scanPh': { key: 'dm.scanPh', en: '🔍 Code / name / barcode — or scan via 📷', roman: '🔍 Code / name / barcode — ya 📷 se scan karein', ur: '🔍 کوڈ / نام / بارکوڈ — یا 📷 سے اسکین کریں' },
  'dm.noCatPh': { key: 'dm.noCatPh', en: 'No catalog? Type a name — availability will be checked', roman: 'Catalog na ho to naam type karein — availability check ho jayega', ur: 'کیٹلاگ نہ ہو تو نام ٹائپ کریں — دستیابی چیک ہو جائے گی' },
  'dm.internalHint': { key: 'dm.internalHint', en: 'Internal use — not visible to the customer', roman: 'Internal use — customer ko nahi dikhta', ur: 'اندرونی استعمال — کسٹمر کو نظر نہیں آتا' },
  'dm.followHint': { key: 'dm.followHint', en: 'Day to contact the customer again', roman: 'Is din dobara customer se rabta karna hai', ur: 'اس دن کسٹمر سے دوبارہ رابطہ کرنا ہے' },
  'dm.dupTail': { key: 'dm.dupTail', en: ' — complete/cancel that demand first.', roman: ' — pehle us demand ko complete/cancel karein.', ur: ' — پہلے اس ڈیمانڈ کو مکمل/منسوخ کریں۔' },
  'dm.dupSaveTail': { key: 'dm.dupSaveTail', en: ' — complete/cancel that demand first, or save will be blocked.', roman: ' — pehle us demand ko complete/cancel karein, warna save block hoga.', ur: ' — پہلے اس ڈیمانڈ کو مکمل/منسوخ کریں، ورنہ سیو بلاک ہو گا۔' },
  'dm.noPhone': { key: 'dm.noPhone', en: 'no phone', roman: 'phone nahi', ur: 'فون نہیں' },
  'dm.noOpen': { key: 'dm.noOpen', en: 'No open demands', roman: 'Koi open demand nahi', ur: 'کوئی کھلا ڈیمانڈ نہیں' },
  'dm.newJourney': { key: 'dm.newJourney', en: 'A new demand journey can start', roman: 'Naya demand safar shuru kar sakte hain', ur: 'نیا ڈیمانڈ سفر شروع کر سکتے ہیں' },
  'dm.noStockInfo': { key: 'dm.noStockInfo', en: 'No stock info', roman: 'Stock info nahi', ur: 'اسٹاک معلومات نہیں' },
  'dm.oos': { key: 'dm.oos', en: 'Out of stock — sourcing needed', roman: 'Out of stock — sourcing lagegi', ur: 'اسٹاک ختم — سورسنگ ضروری' },
  'dm.notInStock': { key: 'dm.notInStock', en: 'Item not in stock — the PO Suggestions tab can link this demand to a supplier.', roman: 'Ye item stock mein nahi — PO Suggestions tab is demand ko supplier ke sath jor sakta hai.', ur: 'یہ آئٹم اسٹاک میں نہیں — PO Suggestions ٹیب یہ ڈیمانڈ سپلائر سے جوڑ سکتا ہے۔' },
  'dm.dupOpen': { key: 'dm.dupOpen', en: 'This demand is already open (', roman: 'Ye demand pehle se open hai (', ur: 'یہ ڈیمانڈ پہلے سے کھلا ہے (' },
  'dm.saveAnywayTail': { key: 'dm.saveAnywayTail', en: ') — complete/cancel it first', roman: ') — pehle us ko complete/cancel karein', ur: ') — پہلے اسے مکمل/منسوخ کریں' },
  'dm.datePast': { key: 'dm.datePast', en: 'Expected date has passed (', roman: 'Expected date guzar chuki hai (', ur: 'متوقع تاریخ گزر چکی ہے (' },
  'dm.saveAnyway': { key: 'dm.saveAnyway', en: ') — save anyway?', roman: ') — phir bhi save karein?', ur: ') — پھر بھی محفوظ کریں؟' },
  'dm.budgetLow': { key: 'dm.budgetLow', en: 'Budget price is below cost (cost ', roman: 'Budget price cost se kam hai (cost ', ur: 'بجٹ قیمت لاگت سے کم ہے (لاگت ' },
  'dm.noCustId': { key: 'dm.noCustId', en: 'Customer id not found', roman: 'Customer id nahi mili', ur: 'کسٹمر id نہیں ملی' },
  'dm.custFail': { key: 'dm.custFail', en: 'Could not add customer: ', roman: 'Customer add nahi ho saka: ', ur: 'کسٹمر شامل نہیں ہو سکا: ' },
  'dm.updated': { key: 'dm.updated', en: 'Demand updated ✅', roman: 'Demand update ho gayi ✅', ur: 'ڈیمانڈ اپڈیٹ ہو گئی ✅' },
  'dm.saved': { key: 'dm.saved', en: 'Demand saved ✅', roman: 'Demand save ho gayi ✅', ur: 'ڈیمانڈ محفوظ ہو گئی ✅' },
  'dm.noPerm': { key: 'dm.noPerm', en: 'Permission denied', roman: 'Permission nahi hai', ur: 'اجازت نہیں ہے' },
  'dm.copySub': { key: 'dm.copySub', en: 'Copy from an old demand — adjust qty/date for the new one. (F9 = save)', roman: 'Purani demand se copy — qty/date adjust kar ke naya demand banayein. (F9 = save)', ur: 'پرانی ڈیمانڈ سے کاپی — qty/date ایڈجسٹ کر کے نیا ڈیمانڈ بنائیں۔ (F9 = سیو)' },
  'dm.noItemInfo': { key: 'dm.noItemInfo', en: 'Item info missing', roman: 'Item info nahi hai', ur: 'آئٹم معلومات نہیں ہے' },
  'dm.allClear': { key: 'dm.allClear', en: 'No outstanding demands — nothing pending for PO', roman: 'Koi outstanding demand nahi — PO ke liye kuch pending nahi', ur: 'کوئی بقیہ ڈیمانڈ نہیں — PO کے لیے کچھ زیرِ التوا نہیں' },
  'dm.noneSel': { key: 'dm.noneSel', en: 'No items selected', roman: 'Koi item select nahi', ur: 'کوئی آئٹم منتخب نہیں' },
  'mt.itemsLoadFail': { key: 'mt.itemsLoadFail', en: 'Items failed to load', roman: 'Items load nahi ho sake', ur: 'آئٹمز لوڈ نہیں ہو سکے' },
  'mt.noItems': { key: 'mt.noItems', en: 'No items found', roman: 'Koi item nahi mila', ur: 'کوئی آئٹم نہیں ملا' },
  'mt.noItemsHint': { key: 'mt.noItemsHint', en: 'Add a new item or import from Excel/CSV (Items ▸ Import).', roman: 'Naya item add karein ya Excel/CSV se import karein (Items ▸ Import).', ur: 'نیا آئٹم شامل کریں یا Excel/CSV سے درآمد کریں (Items ▸ Import)۔' },
  'mt.barcodeTile': { key: 'mt.barcodeTile', en: 'Open Barcode & Labels tab to print the label', roman: 'Print label ke liye Barcode & Labels tab kholein', ur: 'لیبل پرنٹ کے لیے Barcode & Labels ٹیب کھولیں' },
  'mt.noNote': { key: 'mt.noNote', en: 'No note — add one via Edit', roman: 'Koi note nahi — Edit me add karein', ur: 'کوئی نوٹ نہیں — Edit سے شامل کریں' },
  'mt.noRules': { key: 'mt.noRules', en: 'No special price rules', roman: 'Koi special price rule nahi', ur: 'کوئی خاص قیمت رول نہیں' },
  'mt.noStockRec': { key: 'mt.noStockRec', en: 'No stock record found', roman: 'Stock record nahi mila', ur: 'اسٹاک ریکارڈ نہیں ملا' },
  'mt.fileReadFail': { key: 'mt.fileReadFail', en: 'Could not read file', roman: 'File parh nahi saka', ur: 'فائل پڑھ نہیں سکا' },
  'mt.imgInvalid': { key: 'mt.imgInvalid', en: 'Not a valid image', roman: 'Ye image nahi hai', ur: 'یہ درست تصویر نہیں ہے' },
  'mt.uploaded': { key: 'mt.uploaded', en: '✅ Uploaded', roman: '✅ Upload ho gayi', ur: '✅ اپلوڈ ہو گئی' },
  'mt.noImg': { key: 'mt.noImg', en: '🖼 No image — upload via 📁 or 📷 above', roman: '🖼 No image — upar 📁 ya 📷 se upload karein', ur: '🖼 کوئی تصویر نہیں — اوپر 📁 یا 📷 سے اپلوڈ کریں' },
  'mt.noCustom': { key: 'mt.noCustom', en: 'No custom fields defined', roman: 'Koi custom field define nahi', ur: 'کوئی کسٹم فیلڈ ڈیفائن نہیں' },
  'mt.imgUrlHint': { key: 'mt.imgUrlHint', en: 'Paste a URL, or use 📁 Upload / 📷 Camera — uploaded to Drive on Save', roman: 'URL paste karein, ya 📁 Upload / 📷 Camera se lein — Save par Drive me upload ho jayegi', ur: 'URL پیسٹ کریں، یا 📁 اپلوڈ / 📷 کیمرہ استعمال کریں — Save پر Drive میں اپلوڈ ہو جائے گی' },
  'mt.newProduct': { key: 'mt.newProduct', en: 'Create a new product', roman: 'Naya product banayein', ur: 'نیا پروڈکٹ بنائیں' },
  'mt.nameReq': { key: 'mt.nameReq', en: 'Name is required', roman: 'Name zaroori hai', ur: 'نام ضروری ہے' },
  'mt.savedImgFail': { key: 'mt.savedImgFail', en: 'Item saved, image upload failed: ', roman: 'Item save ho gaya, image upload fail: ', ur: 'آئٹم محفوظ ہو گیا، تصویر اپلوڈ ناکام: ' },
  'mt.driveCheck': { key: 'mt.driveCheck', en: ' — check Drive', roman: ' — Drive check karein', ur: ' — Drive چیک کریں' },
  'mt.pasteHint': { key: 'mt.pasteHint', en: 'Copy-paste from Excel/Sheet. Existing code → update, new → create.', roman: 'Excel/Sheet se copy kar ke paste karein. Existing code → update, naya → create.', ur: 'Excel/Sheet سے کاپی پیسٹ کریں۔ موجودہ کوڈ → اپڈیٹ، نیا → تخلیق۔' },
  'mt.noRec': { key: 'mt.noRec', en: 'Record not found', roman: 'Record nahi mila', ur: 'ریکارڈ نہیں ملا' },
  'mt.hasUdhaar': { key: 'mt.hasUdhaar', en: 'Owes balance (type amount)', roman: 'Has udhaar (type amount)', ur: 'واجب الادا بیلنس (رقم لکھیں)' },
  'mt.curUdhaar': { key: 'mt.curUdhaar', en: 'Current balance (Outstanding)', roman: 'Current udhaar (Outstanding)', ur: 'موجودہ بیلنس (بقایا)' },
  'mt.outPayable': { key: 'mt.outPayable', en: 'Outstanding payable', roman: 'Outstanding payable', ur: 'بقایا ادائیگی' },
  'mt.curBal': { key: 'mt.curBal', en: 'Current balance', roman: 'Current udhaar (balance)', ur: 'موجودہ بیلنس' },
  'mt.payBal': { key: 'mt.payBal', en: 'Payable balance', roman: 'Payable balance', ur: 'ادا کرنی والی بیلنس' },
  'mt.rfDesc': { key: 'mt.rfDesc', en: 'Compare last 2 GRN rates per item · biggest gap first', roman: 'Item ki aakhri 2 GRN rates ka muqabla · sab se zyada farq pehle', ur: 'آئٹم کی آخری 2 GRN ریٹس کا موازنہ · سب سے زیادہ فرق پہلے' },
  'mt.rfEmpty': { key: 'mt.rfEmpty', en: 'No rate gaps — only items with 2+ GRN rates signal', roman: 'Koi rate-farq nahi mila — (2 GRN rates wale items hi signal dete hain)', ur: 'کوئی ریٹ فرق نہیں — صرف 2+ GRN ریٹس والے آئٹمز سگنل دیتے ہیں' },
  'mt.gap': { key: 'mt.gap', en: 'Gap', roman: 'Farq', ur: 'فرق' },
  'mt.recvPay': { key: 'mt.recvPay', en: '💰 Receive payment', roman: '💰 Payment receive karein', ur: '💰 ادائیگی وصول کریں' },
  'mt.openBal': { key: 'mt.openBal', en: 'Opening balance', roman: 'Opening udhaar', ur: 'اوپننگ بیلنس' },
  'mt.supCreditHint': { key: 'mt.supCreditHint', en: 'How much credit the supplier has given', roman: 'Supplier ne kitna udhaar diya hai', ur: 'سپلائر نے کتنا کریڈٹ دیا ہے' },
  'iv2.noItems': { key: 'iv2.noItems', en: 'No items yet', roman: 'Abhi koi item nahi', ur: 'ابھی کوئی آئٹم نہیں' },
  'iv2.noItemsHint': { key: 'iv2.noItemsHint', en: 'Add products from the Items screen — they appear here even with no stock (0 stock ≈ Out of stock).', roman: 'Items screen se products add karein — stock ke baghair bhi yahan nazar aayenge (0 stock ≈ Out of stock).', ur: 'Items اسکرین سے پروڈکٹس شامل کریں — بغیر اسٹاک بھی یہاں نظر آئیں گے (0 اسٹاک ≈ آؤٹ آف اسٹاک)۔' },
  'iv2.searchPh': { key: 'iv2.searchPh', en: '🔎 Search code / name / brand / barcode…', roman: '🔎 Code / naam / brand / barcode se dhoondein…', ur: '🔎 کوڈ / نام / برانڈ / بارکوڈ تلاش کریں…' },
  'iv2.allLoadFail': { key: 'iv2.allLoadFail', en: 'All-inventory failed to load', roman: 'All inventory load nahi ho saka', ur: 'مکمل انوینٹری لوڈ نہیں ہو سکی' },
  'iv2.zeroTitle': { key: 'iv2.zeroTitle', en: 'Also show zero-stock items in this table', roman: 'Zero-stock items bhi is table mein dikhayein', ur: 'زیرو اسٹاک آئٹمز بھی اس ٹیبل میں دکھائیں' },
  'iv2.zeroLabel': { key: 'iv2.zeroLabel', en: 'Show zero-stock items too', roman: 'Zero-stock items bhi dikhayein', ur: 'زیرو اسٹاک آئٹمز بھی دکھائیں' },
  'iv2.noBranchStock': { key: 'iv2.noBranchStock', en: 'No stock in this branch', roman: 'Is branch mein koi stock nahi', ur: 'اس برانچ میں کوئی اسٹاک نہیں' },
  'iv2.addViaItems': { key: 'iv2.addViaItems', en: 'Add products from the Items screen.', roman: 'Items screen se products add karein.', ur: 'Items اسکرین سے پروڈکٹس شامل کریں۔' },
  'iv2.noStockHint': { key: 'iv2.noStockHint', en: 'Add items, or bring stock via GRN / stock adjustment — or show zero-stock items with the switch above.', roman: 'Items add karein ya GRN / stock adjustment se stock daalein — ya upar switch se zero-stock items dikhayein.', ur: 'آئٹمز شامل کریں یا GRN / اسٹاک ایڈجسٹمنٹ سے اسٹاک لائیں — یا اوپر والے سوئچ سے زیرو اسٹاک آئٹمز دکھائیں۔' },
  'iv2.levelsLoadFail': { key: 'iv2.levelsLoadFail', en: 'Stock levels failed to load', roman: 'Stock levels load nahi ho sake', ur: 'اسٹاک لیولز لوڈ نہیں ہو سکے' },
  'iv2.reverseAsk': { key: 'iv2.reverseAsk', en: 'Reverse this? Stock will be flipped back.', roman: 'Reverse karein? Stock ulta ho jaye ga.', ur: 'ریورس کریں؟ اسٹاک واپس الٹ دیا جائے گا۔' },
  'iv2.sheetHint': { key: 'iv2.sheetHint', en: 'Generate the sheet, fill counted qty, then post it as an Adjustment.', roman: 'Sheet generate karein, phir counted qty bharein aur Adjustment ke tor par post karein.', ur: 'شیٹ بنائیں، گنی ہوئی qty بھریں، پھر ایڈجسٹمنٹ کے طور پر پوسٹ کریں۔' },
  'iv2.noLots': { key: 'iv2.noLots', en: 'No lots — turn on lot/expiry tracking in Settings ▸ Inventory', roman: 'Koi lot nahi — Settings ▸ Inventory se lot/expiry tracking on karein', ur: 'کوئی لاٹ نہیں — Settings ▸ Inventory سے لاٹ/ایکسپائری ٹریکنگ آن کریں' },
  'iv2.noLines': { key: 'iv2.noLines', en: 'No lines', roman: 'Koi line nahi', ur: 'کوئی لائن نہیں' },
  'iv2.sameBranch': { key: 'iv2.sameBranch', en: 'From / To branches must differ — pick To again', roman: 'From / To branch alag honi chahiye — To dobara chunein', ur: 'From / To برانچ مختلف ہونی چاہیے — To دوبارہ منتخب کریں' },
  'iv2.bothBranches': { key: 'iv2.bothBranches', en: 'Pick both From and To branches', roman: 'From aur To branch dono chunein', ur: 'From اور To دونوں برانچ منتخب کریں' },
  'iv2.addItems': { key: 'iv2.addItems', en: 'Add items', roman: 'Items add karein', ur: 'آئٹمز شامل کریں' },
  'iv2.binHint': { key: 'iv2.binHint', en: 'Select an item and choose the target bin — placement updates instantly.', roman: 'Item select karein aur target bin choose karein — placement turant update ho jayegi.', ur: 'آئٹم منتخب کریں اور ہدف بن منتخب کریں — جگہ فوراً اپڈیٹ ہو جائے گی۔' },
  'iv2.notFound': { key: 'iv2.notFound', en: 'Not found: ', roman: 'Nahi mila: ', ur: 'نہیں ملا: ' },
  'iv2.scanNoHit': { key: 'iv2.scanNoHit', en: 'No item found — check the code/name', roman: 'Koi item nahi mila — code/naam check karein', ur: 'کوئی آئٹم نہیں ملا — کوڈ/نام چیک کریں' },
  'iv2.binAssigned': { key: 'iv2.binAssigned', en: 'Bin assigned ✅', roman: 'Bin assign ho gaya ✅', ur: 'بن تفویض ہو گئی ✅' },
  'iv2.binCodeReq': { key: 'iv2.binCodeReq', en: 'Bin code is required', roman: 'Bin code zaroori hai', ur: 'بن کوڈ ضروری ہے' },
  'bt.noAlertsFilter': { key: 'bt.noAlertsFilter', en: 'No alerts for this filter — change it', roman: 'Is filter me koi alert nahi — filter badlein', ur: 'اس فلٹر میں کوئی الرٹ نہیں — فلٹر بدلیں' },
  'bt.allClear': { key: 'bt.allClear', en: 'All clear — no alerts', roman: 'All clear — koi alert nahi', ur: 'سب ٹھیک ہے — کوئی الرٹ نہیں' },
  'bt.notifTitle': { key: 'bt.notifTitle', en: 'Mark as read · tap to open', roman: 'Mark as read · khulne ke liye tap karein', ur: 'پڑھا ہوا نشان زد کریں · کھولنے کے لیے ٹیپ کریں' },
  'bt.markFail': { key: 'bt.markFail', en: 'Mark-as-read failed — try again', roman: 'Mark read fail — dobara try karein', ur: 'پڑھا ہوا نشان زد ناکام — دوبارہ کوشش کریں' },
  'bt.sessionExpired': { key: 'bt.sessionExpired', en: 'Session expired — please log in again.', roman: 'Session expire ho gaya — dobara login karein.', ur: 'سیشن ختم ہو گیا — دوبارہ لاگ ان کریں۔' },
  'bt.fsFail': { key: 'bt.fsFail', en: 'Full screen is not working on this device', roman: 'Full screen is device par kaam nahi kar raha', ur: 'فل اسکرین اس ڈیوائس پر کام نہیں کر رہی' },
  'bt.helpFail': { key: 'bt.helpFail', en: 'Help failed to open', roman: 'Help khul nahi saki', ur: 'ہیلپ کھلی نہیں' },
  'bt.shopClosed': { key: 'bt.shopClosed', en: 'Shop is CLOSED — click to start the day (opening cash)', roman: 'Shop BAND hai — click kar ke din shuru karein (opening cash)', ur: 'دکان بند ہے — دن شروع کرنے کے لیے کلک کریں (اوپننگ کیش)' },
  'bt.shopOpened': { key: 'bt.shopOpened', en: 'Shop opened ✅', roman: 'Shop open ho gayi ✅', ur: 'دکان کھل گئی ✅' },
  'bt.nothingFound': { key: 'bt.nothingFound', en: 'Nothing found', roman: 'Kuch nahi mila', ur: 'کچھ نہیں ملا' },
  'bt.shopDlgFail': { key: 'bt.shopDlgFail', en: 'Shop dialog failed to open', roman: 'Shop dialog nahi khula', ur: 'شاپ ڈائیلاگ کھلا نہیں' },
  'bt.wizardFail': { key: 'bt.wizardFail', en: 'Wizard failed to open: ', roman: 'Wizard nahi khula: ', ur: 'وزرڈ کھلا نہیں: ' },
  'bt.close': { key: 'bt.close', en: 'Close', roman: 'Band karein', ur: 'بند کریں' },
  'bt.newPw': { key: 'bt.newPw', en: 'New password (leave empty to keep unchanged)', roman: 'Naya password (khali chhorein to nahi badle ga)', ur: 'نیا پاس ورڈ (خالی چھوڑیں تو نہیں بدلے گا)' },
  'bt.shopOpenStep': { key: 'bt.shopOpenStep', en: 'Shop must be OPEN before sales/operations (the v2.30.0 rule).', roman: 'Sale/operational kaam se pehle shop OPEN lazmi hai (v2.30.0 ka rule).', ur: 'سیل/آپریشنز سے پہلے دکان کھلی ہونا لازمی ہے (v2.30.0 کا اصول)۔' },
  'bt.skip': { key: 'bt.skip', en: '⏭ Skip (not now)', roman: '⏭ Skip (abhi nahi)', ur: '⏭ skipping (ابھی نہیں)' },
  'bt.skipped': { key: 'bt.skipped', en: 'Setup skipped — you can rerun it from Settings ▸ Shop', roman: 'Setup skip hua — Settings ▸ Shop screen se dobara chala sakte hain', ur: 'سیٹ اپ چھوڑ دیا گیا — Settings ▸ Shop اسکرین سے دوبارہ چلا سکتے ہیں' },
  'bt.finish': { key: 'bt.finish', en: '✅ Finish', roman: '✅ Mukammal karein', ur: '✅ مکمل کریں' },
  'bt.pwFail': { key: 'bt.pwFail', en: 'Password change failed: ', roman: 'Password change nahi hua: ', ur: 'پاس ورڈ تبدیل نہیں ہوا: ' },
  'bt.setupDone': { key: 'bt.setupDone', en: 'Setup complete ✅', roman: 'Setup mukammal ✅', ur: 'سیٹ اپ مکمل ✅' },
  'bt.blocked': { key: 'bt.blocked', en: 'Shop is closed — this action was blocked. Open the shop and try again.', roman: 'Shop band hai — ye kaam block ho gaya. Shop kholain aur dobara koshish karein.', ur: 'دکان بند ہے — یہ کام بلاک ہو گیا۔ دکان کھولیں اور دوبارہ کوشش کریں۔' },
  'qr.typePh': { key: 'qr.typePh', en: 'Type code / QR value and press Enter', roman: 'Code / QR value type karke Enter dabayein', ur: 'کوڈ / QR ویلیو ٹائپ کر کے Enter دبائیں' },
  'qr.scanNoOpen': { key: 'qr.scanNoOpen', en: 'Scanner could not open — type the code below.', roman: 'Scanner open nahi ho saka — code neeche type karein.', ur: 'اسکینر کھلا نہیں — کوڈ نیچے ٹائپ کریں۔' },
  'qr.popupBlocked': { key: 'qr.popupBlocked', en: 'Popup blocked — allow popups for this site', roman: 'Popup block ho gaya — is site ke liye popups allow karein', ur: 'پاپ اپ بلاک ہو گیا — اس سائٹ کے لیے پاپ اپ کی اجازت دیں' },
  'qr.popupNote': { key: 'qr.popupNote', en: 'Popup was blocked. Type the code or allow popups.', roman: 'Popup block hua. Code type karein ya popup permission dein.', ur: 'پاپ اپ بلاک ہوا۔ کوڈ ٹائپ کریں یا پاپ اپ کی اجازت دیں۔' },
  'qr.noResult': { key: 'qr.noResult', en: 'No result from scanner — manual entry', roman: 'Scanner se result nahi aaya — manual entry', ur: 'اسکینر سے نتیجہ نہیں آیا — دستی اندراج' },
  'qr.timeoutNote': { key: 'qr.timeoutNote', en: 'Scanner sent no result within 2 minutes (check camera permission or network).', roman: 'Scanner ne 2 minute mein result nahi bheja (camera permission ya network check karein).', ur: 'اسکینر نے 2 منٹ میں نتیجہ نہیں بھیجا (کیمرہ اجازت یا نیٹ ورک چیک کریں)۔' },
  'qr.winClosed': { key: 'qr.winClosed', en: 'Scanner window closed — manual entry', roman: 'Scanner window band ho gayi — manual entry', ur: 'اسکینر ونڈو بند ہو گئی — دستی اندراج' },
  'qr.winClosedNote': { key: 'qr.winClosedNote', en: 'Scanner window closed. Type the code here and press Enter.', roman: 'Scanner window band ho gayi. Code yahan type karke Enter dabayein.', ur: 'اسکینر ونڈو بند ہو گئی۔ کوڈ یہاں ٹائپ کر کے Enter دبائیں۔' },
  'qr.typeBtn': { key: 'qr.typeBtn', en: '⌨ Type manually', roman: '⌨ Manually type karein', ur: '⌨ دستی طور پر ٹائپ کریں' },
  'qr.photoBtn': { key: 'qr.photoBtn', en: '📷 Scan from a photo', roman: '📷 Photo kheench kar scan karein', ur: '📷 تصویر سے اسکین کریں' },
  'qr.bulkStop': { key: 'qr.bulkStop', en: '🔁 Stop bulk', roman: '🔁 Bulk band karein', ur: '🔁 بلک بند کریں' },
  'qr.noPhotoDecode': { key: 'qr.noPhotoDecode', en: 'Photo decode not supported in this browser — try manual', roman: 'Is browser mein photo decode nahi — manual try karein', ur: 'اس براؤزر میں تصویر ڈی کوڈ نہیں — دستی کوشش کریں' },
  'qr.noCodeInPhoto': { key: 'qr.noCodeInPhoto', en: 'No code found in photo — retake or type it', roman: 'Photo mein code nahi mila — dobara kheenchein ya type karein', ur: 'تصویر میں کوڈ نہیں ملا — دوبارہ لیں یا ٹائپ کریں' },
  'qr.decodeFail': { key: 'qr.decodeFail', en: 'Decode failed — try manual', roman: 'Decode fail — manual try karein', ur: 'ڈی کوڈ ناکام — دستی کوشش کریں' },
  'qr.noCam': { key: 'qr.noCam', en: '⚠ Camera scan cannot run in this browser — set scanner.liveUrl in Settings ▸ Mobile apps (PWA) on mobile, or type below.', roman: '⚠ Is browser mein camera scan nahi chal sakta — mobile par Settings ▸ Mobile apps (PWA) mein scanner.liveUrl set karein, ya neeche type karein.', ur: '⚠ اس براؤزر میں کیمرہ اسکین نہیں چل سکتا — موبائل پر Settings ▸ Mobile apps (PWA) میں scanner.liveUrl سیٹ کریں، یا نیچے ٹائپ کریں۔' },
  'qr.inAppCamOff': { key: 'qr.inAppCamOff', en: 'In-app camera is off in Settings — attach an external scanner or type.', roman: 'In-app camera Settings mein band hai — external scanner lagayein ya type karein.', ur: 'ان ایپ کیمرہ Settings میں بند ہے — بیرونی اسکینر لگائیں یا ٹائپ کریں۔' },
  'qr.noDetector': { key: 'qr.noDetector', en: 'Detector not available — manual entry.', roman: 'Detector available nahi — manual entry.', ur: 'ڈیٹیکٹر دستیاب نہیں — دستی اندراج۔' },
  'qr.camBlocked': { key: 'qr.camBlocked', en: '⚠ Camera blocked (Apps Script sandbox or permission) — use photo/manual, or better: set scanner.liveUrl.', roman: '⚠ Camera block hai (Apps Script sandbox ya permission) — photo/manual use karein, ya behtar hal: scanner.liveUrl set karein.', ur: '⚠ کیمرہ بلاک ہے (Apps Script سینڈ باکس یا اجازت) — تصویر/دستی استعمال کریں، یا بہتر: scanner.liveUrl سیٹ کریں۔' },
  'qr.bulkCount': { key: 'qr.bulkCount', en: '🔁 Bulk — ', roman: '🔁 Bulk — ', ur: '🔁 بلک — ' },
  'qr.bulkCountTail': { key: 'qr.bulkCountTail', en: ' codes scanned (close the modal to stop)', roman: ' code scan hue (modal band karke rukwayein)', ur: ' کوڈ اسکین ہوئے (روکنے کے لیے ماڈل بند کریں)' },
  'qr.noInvoice': { key: 'qr.noInvoice', en: 'Invoice not found: ', roman: 'Invoice nahi mili: ', ur: 'انوائس نہیں ملی: ' },
  'qr.noDoc': { key: 'qr.noDoc', en: 'Not in document registry: ', roman: 'Document registry me nahi mila: ', ur: 'ڈاکیومنٹ رجسٹری میں نہیں ملا: ' },
  'qr.docNoLink': { key: 'qr.docNoLink', en: 'Doc found (', roman: 'Doc mila (', ur: 'ڈاکیومنٹ ملا (' },
  'qr.docNoLinkTail': { key: 'qr.docNoLinkTail', en: ') — no screen link for this entity yet', roman: ') — is entity ka screen link abhi nahi', ur: ') — اس انٹٹی کا اسکرین لنک ابھی نہیں' },
  'qr.resolveFail': { key: 'qr.resolveFail', en: 'Could not resolve code: ', roman: 'Code resolve nahi hua: ', ur: 'کوڈ ریزولو نہیں ہوا: ' },
  'cm.sendTo': { key: 'cm.sendTo', en: 'Send to (phone or email)', roman: 'Bhejein (phone ya email)', ur: 'بھیجیں (فون یا ای میل)' },
  'cm.copied': { key: 'cm.copied', en: 'Message copied', roman: 'Message copy ho gaya', ur: 'پیغام کاپی ہو گیا' },
  'cm.freeMode': { key: 'cm.freeMode', en: 'Free mode: opens a wa.me link — the message arrives pre-filled in WhatsApp app/web. For an API key choose META or TWILIO in Settings ▸ Automation ▸ WhatsApp & SMS.', roman: 'Free mode: wa.me link khulta hai — WhatsApp app/web me message tayar mil jata hai. API key chahiye to Settings ▸ Automation ▸ WhatsApp & SMS me META ya TWILIO chunein.', ur: 'فری موڈ: wa.me لنک کھلتا ہے — واٹس ایپ ایپ/ویب میں پیغام تیار ملتا ہے۔ API key کے لیے Settings ▸ Automation ▸ WhatsApp & SMS میں META یا TWILIO منتخب کریں۔' },
  'cm.csvDone': { key: 'cm.csvDone', en: 'CSV downloaded (', roman: 'CSV download ho gaya (', ur: 'CSV ڈاؤن لوڈ ہو گیا (' },
  'cm.rows': { key: 'cm.rows', en: ') rows)', roman: ' rows)', ur: ' سطریں)' },
  'cm.xlsDone': { key: 'cm.xlsDone', en: 'Excel file downloaded', roman: 'Excel file download ho gayi', ur: 'ایکسل فائل ڈاؤن لوڈ ہو گئی' },
  'cm.noShare': { key: 'cm.noShare', en: 'Web Share not available in this browser', roman: 'Is browser me Web Share nahi hai', ur: 'اس براؤزر میں Web Share نہیں ہے' },
  'cm.noneSent': { key: 'cm.noneSent', en: 'No messages sent yet', roman: 'Abhi koi message nahi bheja gaya', ur: 'ابھی کوئی پیغام نہیں بھیجا گیا' },
  'cm.resent': { key: 'cm.resent', en: 'Sent again', roman: 'Dobara bheja', ur: 'دوبارہ بھیجا' },
  'cm.csvPh': { key: 'cm.csvPh', en: 'Paste CSV — header: code,name,brand,cost,retail,wholesale,barcode', roman: 'CSV paste karein — header: code,name,brand,cost,retail,wholesale,barcode', ur: 'CSV پیسٹ کریں — ہیڈر: code,name,brand,cost,retail,wholesale,barcode' },
  'cm.needPreview': { key: 'cm.needPreview', en: 'Generate a preview first', roman: 'Pehle preview banayein', ur: 'پہلے پیش نظارہ بنائیں' },
  'cm.noRowsSel': { key: 'cm.noRowsSel', en: 'No rows selected', roman: 'Koi row select nahi', ur: 'کوئی قطار منتخب نہیں' },
  'cm.applyAsk': { key: 'cm.applyAsk', en: 'rows — apply? (cost/price will update)', roman: ' rows apply karein? (cost/price update hoga)', ur: ' قطاریں — لاگو کریں؟ (لاگت/قیمت اپڈیٹ ہو گی)' },
  'cm.noAttach': { key: 'cm.noAttach', en: 'No attachments found (change the Gmail search query in Settings)', roman: 'Koi attachment nahi mila (Gmail search query Settings me badlein)', ur: 'کوئی اٹیچمنٹ نہیں ملا (Gmail سرچ کیوری Settings میں بدلیں)' },
  'cm.filePick': { key: 'cm.filePick', en: '📁 Choose file (CSV)', roman: '📁 File chunein (CSV)', ur: '📁 فائل منتخب کریں (CSV)' },
  'cm.fbHint': { key: 'cm.fbHint', en: 'Set FIREBASE_DB_URL + FIREBASE_DB_SECRET (Realtime DB) or FIREBASE_PROJECT_ID + FIREBASE_ID_TOKEN (Firestore) in Script Properties.', roman: 'Script Properties me FIREBASE_DB_URL + FIREBASE_DB_SECRET (Realtime DB) ya FIREBASE_PROJECT_ID + FIREBASE_ID_TOKEN (Firestore) set karein.', ur: 'Script Properties میں FIREBASE_DB_URL + FIREBASE_DB_SECRET (Realtime DB) یا FIREBASE_PROJECT_ID + FIREBASE_ID_TOKEN (Firestore) سیٹ کریں۔' },
  'aic.needKey': { key: 'aic.needKey', en: 'To run AI, either enter an API key, choose the Local Data Assistant (no LLM), or turn on its fallback.', roman: 'AI chalane ke liye ya to API key daalein, ya Local Data Assistant (bina LLM) chunein, ya uska fallback on karein.', ur: 'AI chalane ke liye ya to API key daalein, ya Local Data Assistant (bina LLM) chunein, ya uska fallback on karein.' },
  'aic.stored': { key: 'aic.stored', en: 'Stored: ', roman: 'Mehfooz: ', ur: 'محفوظ: ' },
  'aic.storedTail': { key: 'aic.storedTail', en: ' — changes when you enter a new one', roman: ' — naya daalne par badal jaye gi', ur: ' — نیا ڈالنے پر بدل جائے گی' },
  'aic.keySafe': { key: 'aic.keySafe', en: 'The key is stored only in Script Properties — never in Sheets or the browser. Replies never return the full key (just a hint like ', roman: 'Key sirf Script Properties mein mehfooz hoti hai — Sheets ya browser mein kahin nahi. Jawab mein kabhi poori key wapas nahi aati (sirf ', ur: 'Key sirf Script Properties mein mehfooz hoti hai — Sheets ya browser mein kahin nahi. Jawab mein kabhi poori key wapas nahi aati (sirf ' },
  'aic.keyHintDflt': { key: 'aic.keyHintDflt', en: 'first 4…last 3', roman: 'pehle 4…aakhir 3', ur: 'پہلے 4…آخری 3' },
  'aic.endpointHelp': { key: 'aic.endpointHelp', en: 'Change only if you use a proxy or your own gateway. Most users should leave it empty.', roman: 'Sirf tab badlein jab aap proxy/khudi ka gateway use kar rahe hon. Aksar users ke liye khali chhor dein.', ur: 'Sirf tab badlein jab aap proxy/khudi ka gateway use kar rahe hon. Aksar users ke liye khali chhor dein.' },
  'aic.interactions': { key: 'aic.interactions', en: 'Interactions API is Google\'s newer standard (with function-calling steps) — Auto mode tries it first, then legacy generateContent. Our engine runs store=false (stateless): the app never asks for conversation storage; the provider\'s security/retention policy still applies.', roman: 'Interactions API Google ka naya standard hai (function-calling steps ke sath) — Auto mode pehle isi ko try karta hai, phir legacy generateContent. Hamara engine store=false (stateless) chalta hai: app conversation storage request nahi karta; provider ki security/retention policy phir bhi lagu hoti hai.', ur: 'Interactions API Google ka naya standard hai (function-calling steps ke sath) — Auto mode pehle isi ko try karta hai, phir legacy generateContent. Hamara engine store=false (stateless) chalta hai.' },
  'aic.responses': { key: 'aic.responses', en: 'Responses API is OpenAI\'s newer standard (tools + reasoning items) — Auto tries Responses first, then Chat Completions. Temperature is not sent to reasoning models (the API returns 400 — the engine strips and retries).', roman: 'Responses API OpenAI ka naya standard hai (tools + reasoning items) — Auto pehle Responses, phir Chat Completions. Reasoning models par temperature nahi bheja jata (API 400 deti hai — engine khud strip kar ke dobara bhej deta hai).', ur: 'Responses API OpenAI ka naya standard hai (tools + reasoning items) — Auto pehle Responses, phir Chat Completions.' },
  'aic.presetHint': { key: 'aic.presetHint', en: 'A preset only changes the draft — it applies after Save. Hover/tap each chip for details.', roman: 'Preset sirf draft badalta hai — Save ke baad lagoo hoga. Detail ke liye har chip par hover/tap karein.', ur: 'Preset sirf draft badalta hai — Save ke baad lagoo hoga.' },
  'aic.writesOn': { key: 'aic.writesOn', en: 'Writes ON: the assistant can create drafts. Keep "approval required" on — a human still posts.', roman: 'Writes ON: assistant drafts bana sakta hai. "Approval zaroori" on rakhein — post phir bhi insaan karega.', ur: 'Writes ON: assistant drafts bana sakta hai. "Approval zaroori" on rakhein — post phir bhi insaan karega.' },
  'aic.localEngine': { key: 'aic.localEngine', en: 'Without a key this LOCAL rules engine (no LLM) answers rule-based over your real data — so the app never blocks.', roman: 'Key na ho to ye LOCAL rules engine (koi LLM nahi) aap ke asli data par rule-based jawab deta hai — app ruke na ruke.', ur: 'Key na ho to ye LOCAL rules engine (koi LLM nahi) aap ke asli data par rule-based jawab deta hai — app ruke na ruke.' },
  'aic.mockIntro': { key: 'aic.mockIntro', en: 'I am the Local Data Assistant — the app\'s LOCAL rules engine (no LLM). I answer by running tools over your LIVE data.', roman: 'Main Local Data Assistant hoon — app ka LOCAL rules engine (koi LLM nahi). Aapke LIVE data par tools chala kar jawab deta hoon.', ur: 'Main Local Data Assistant hoon — app ka LOCAL rules engine (koi LLM nahi). Aapke LIVE data par tools chala kar jawab deta hoon.' },
  'aic.privNote': { key: 'aic.privNote', en: 'your data never reaches the provider as raw rows — the assistant runs its own tools (under RBAC) and only question/answer text is sent. An LLM can still be wrong — verify important figures.', roman: 'aap ka data provider ko raw rows ki tarah nahi jata — assistant pehle apne tools (RBAC ke tehat) chalata hai aur sirf sawal/jawab ka text jata hai. LLM ghalat jawab bhi de sakta hai — ahem hisaab dekh kar confirm karein.', ur: 'aap ka data provider ko raw rows ki tarah nahi jata — assistant pehle apne tools (RBAC ke tehat) chalata hai aur sirf sawal/jawab ka text jata hai.' },
  'aic.toolsNote': { key: 'aic.toolsNote', en: 'The model can only use tools that are ON. READ tools just read; WRITE tools create drafts (a human still posts). If anything looks off, switch tools off in this tab.', roman: 'Jo tool ON hai, model wahi istemal kar sakta hai. READ tools sirf parhte hain; WRITE drafts banate hain (post phir bhi insaan karta hai). Kuch bhatka hua lage to tools tab se band kar dein.', ur: 'Jo tool ON hai, model wahi istemal kar sakta hai. READ tools sirf parhte hain; WRITE drafts banate hain (post phir bhi insaan karta hai).' },
  'aic.localMode': { key: 'aic.localMode', en: 'local mode · no LLM', roman: 'local mode · no LLM', ur: 'local mode · no LLM' },
  'aic.setupNeeded': { key: 'aic.setupNeeded', en: 'setup needed', roman: 'setup zaroori', ur: 'setup zaroori' },
  'aic.openAgent': { key: 'aic.openAgent', en: 'Open AI Agent', roman: 'AI Agent kholein', ur: 'AI Agent kholein' },
  'od.sub': { key: 'od.sub', en: 'Field orders · status · convert to invoice', roman: 'Field orders · status · invoice mein badlein', ur: 'Field orders · status · invoice mein badlein' },
  'od.cancelAsk': { key: 'od.cancelAsk', en: 'Cancel this order?', roman: 'Order cancel karein?', ur: 'Order cancel karein?' },
  'od.totalTail': { key: 'od.totalTail', en: 'Total ', roman: 'Total ', ur: 'کل ' },
  'od.udhaarNote': { key: 'od.udhaarNote', en: ' · remaining becomes credit', roman: ' · baqi udhaar ban jayega', ur: ' · باقی ادھار بن جائے گا' },
  'od.noLedger': { key: 'od.noLedger', en: 'No ledger entries — new customer', roman: 'Koi ledger entry nahi — naya customer', ur: 'Koi ledger entry nahi — naya customer' },
  'od.scanHint': { key: 'od.scanHint', en: 'Scan → Bulk List → Add All · or tick via search/📋 list', roman: 'Scan → Bulk List → Add All · ya search/📋 list se tick karein', ur: 'Scan → Bulk List → Add All · ya search/📋 list se tick karein' },
  'od.matches': { key: 'od.matches', en: 'matches — pick from the list', roman: 'matches — list se chunein', ur: 'matches — list se chunein' },
  'od.noItemHit': { key: 'od.noItemHit', en: 'No item found', roman: 'Koi item nahi mila', ur: 'Koi item nahi mila' },
  'od.saveBtn': { key: 'od.saveBtn', en: '✅ Save order', roman: '✅ Order save karein', ur: '✅ Order save karein' },
  'od.noItemsYet': { key: 'od.noItemsYet', en: 'No items yet — search above', roman: 'Abhi koi item nahi — upar search karein', ur: 'Abhi koi item nahi — upar search karein' },
  'od.noItems': { key: 'od.noItems', en: 'No items', roman: 'Koi item nahi', ur: 'Koi item nahi' },
  'od.saved': { key: 'od.saved', en: 'Order ', roman: 'Order ', ur: 'Order ' },
  'od.savedTail': { key: 'od.savedTail', en: ' saved ✅', roman: ' save ho gayi ✅', ur: ' save ho gayi ✅' },
  'od.noCustHit': { key: 'od.noCustHit', en: 'No customer found', roman: 'Koi customer nahi mila', ur: 'Koi customer nahi mila' },
  'od.pickCust': { key: 'od.pickCust', en: 'Choose customer', roman: 'Customer chunein', ur: 'Customer chunein' },
  'ro.aiAsk1': { key: 'ro.aiAsk1', en: 'Auto-reorder review: ', roman: 'Auto-reorder review: ', ur: 'Auto-reorder review: ' },
  'ro.noSignals': { key: 'ro.noSignals', en: 'no signals', roman: 'koi signal nahi', ur: 'koi signal nahi' },
  'ro.aiAsk2': { key: 'ro.aiAsk2', en: ' — are these quantities right? Which items should be ordered first, and why?', roman: ' — kya ye quantities theek hain? Kon se items pehle order karein aur kyun?', ur: ' — kya ye quantities theek hain? Kon se items pehle order karein aur kyun?' },
  'ro.noneYet': { key: 'ro.noneYet', en: 'No notable signals yet — stock is moving fine ✅', roman: 'Abhi koi khaas signal nahi — stock theek chal raha hai ✅', ur: 'Abhi koi khaas signal nahi — stock theek chal raha hai ✅' },
  'ro.noAI': { key: 'ro.noAI', en: 'AI assistant not available', roman: 'AI assistant mojood nahi', ur: 'AI assistant mojood nahi' },
  'ro.checkRules': { key: 'ro.checkRules', en: '⚙ Check rules', roman: '⚙ Rules check karein', ur: '⚙ Rules check karein' },
    'ro.neverBelow': { key: 'ro.neverBelow', en: '              (never below the reorder point)\n', roman: '              (kabhi bhi reorderPoint se kam nahi hoga)\n', ur: '              (kabhi bhi reorderPoint se kam nahi hoga)\n' },
'pos.minPrice': { key: 'pos.minPrice', en: 'Min price ', roman: 'Min price ', ur: 'Min price ' },
  'pos.minPriceTail': { key: 'pos.minPriceTail', en: ' — cannot go lower', roman: ' se kam nahi kar saktay', ur: ' se kam nahi kar saktay' },
  'pos.creditBtn': { key: 'pos.creditBtn', en: '📒 Credit', roman: '📒 Udhaar', ur: '📒 Udhaar' },
  'pos.noCustHit': { key: 'pos.noCustHit', en: 'No customer found', roman: 'Koi customer nahi mila', ur: 'Koi customer nahi mila' },
  'pos.pickCust': { key: 'pos.pickCust', en: 'Select customer', roman: 'Customer select karein', ur: 'Customer select karein' },
  'pos.openBal': { key: 'pos.openBal', en: 'Opening balance', roman: 'Opening udhaar (balance)', ur: 'Opening udhaar (balance)' },
  'pos.nameReq': { key: 'pos.nameReq', en: 'Name is required', roman: 'Name zaroori hai', ur: 'Name zaroori hai' },
  'pos.curDue': { key: 'pos.curDue', en: 'Current due (credit)', roman: 'Current Due (udhaar)', ur: 'Current Due (udhaar)' },
  'pos.creditNeedCust': { key: 'pos.creditNeedCust', en: 'Select a customer for credit', roman: 'Udhaar ke liye customer select karein', ur: 'Udhaar ke liye customer select karein' },
  'pos.offlineQueued': { key: 'pos.offlineQueued', en: 'Offline — bill queued', roman: 'Offline bill queue ho gaya', ur: 'Offline bill queue ho gaya' },
  'pos.held': { key: 'pos.held', en: 'Bill held ⏸', roman: 'Bill hold ho gaya ⏸', ur: 'Bill hold ho gaya ⏸' },
  'pos.noHeld': { key: 'pos.noHeld', en: 'No held bills', roman: 'Koi held bill nahi', ur: 'Koi held bill nahi' },
  'pos.clearAsk': { key: 'pos.clearAsk', en: 'Clear the cart? This removes all items from this bill.', roman: 'Cart clear karein? Ye bill ke saare items hata dega.', ur: 'Cart clear karein? Ye bill ke saare items hata dega.' },
  'pws.noItemHit': { key: 'pws.noItemHit', en: 'No items found', roman: 'Koi item nahi mila', ur: 'Koi item nahi mila' },
  'pws.emptyCart': { key: 'pws.emptyCart', en: 'Nothing here yet', roman: 'Abhi kuch nahi', ur: 'Abhi kuch nahi' },
  'pws.creditOpt': { key: 'pws.creditOpt', en: 'Credit', roman: 'Credit / Udhaar', ur: 'Credit / Udhaar' },
  'pws.creditHint': { key: 'pws.creditHint', en: 'For credit you can keep 0 — the balance goes to the customer\'s account', roman: 'Credit ho to 0 rakh sakte hain — baqaya customer ke khaate mein jayega', ur: 'Credit ho to 0 rakh sakte hain — baqaya customer ke khaate mein jayega' },
  'pws.addFirst': { key: 'pws.addFirst', en: 'Add items first', roman: 'Pehle item add karein', ur: 'Pehle item add karein' },
  'pws.offlineQueued': { key: 'pws.offlineQueued', en: 'Offline — sale saved to queue', roman: 'Offline — sale queue mein save ho gayi', ur: 'Offline — sale queue mein save ho gayi' },
  'pws.completeBtn': { key: 'pws.completeBtn', en: '✅ Complete sale', roman: '✅ Sale complete karein', ur: '✅ Sale complete karein' },
  'pws.collectTitle': { key: 'pws.collectTitle', en: 'Credit collection', roman: 'Udhaar wasooli', ur: 'Udhaar wasooli' },
  'pws.pickCust': { key: 'pws.pickCust', en: 'Choose a customer', roman: 'Customer chunein', ur: 'Customer chunein' },
  'pws.offlineQueued2': { key: 'pws.offlineQueued2', en: 'Offline — saved to queue', roman: 'Offline — queue mein save ho gaya', ur: 'Offline — queue mein save ho gaya' },
  'pws.receiveBtn': { key: 'pws.receiveBtn', en: '💰 Receive', roman: '💰 Receive karein', ur: '💰 Receive karein' },
  'pws.settleHint': { key: 'pws.settleHint', en: 'For accounts and returns use ERP ▸ Salesman ▸ Settle — this is only a quick-check view.', roman: 'Hisab-kitab aur return ke liye ERP ▸ Salesman ▸ Settle use karein — yahan sirf jaldi check karne ka view hai.', ur: 'Hisab-kitab aur return ke liye ERP ▸ Salesman ▸ Settle use karein — yahan sirf jaldi check karne ka view hai.' },
  'pws.syncNow': { key: 'pws.syncNow', en: '↻ Sync now', roman: '↻ Abhi sync karein', ur: '↻ Abhi sync karein' },
  ...
  'core.errServerHint': { key: 'core.errServerHint', en: 'The backend returned an error. Try again; if it persists, check the system log (Diagnose).', roman: 'Backend se error aya. Dobara koshish karein; masla rahe to system log (Diagnose) dekhein.', ur: 'بیک اینڈ سے ایرر آیا۔ دوبارہ کوشش کریں؛ مسئلہ رہے تو سسٹم لاگ (Diagnose) دیکھیں۔' },
  'core.errConflictHint': { key: 'core.errConflictHint', en: 'Another save/process is running right now. Wait 2–3 seconds and try again.', roman: 'Koi aur save/process abhi chal raha hai. 2–3 second ruk kar dobara koshish karein.', ur: 'کوئی اور سیو/پروسیس ابھی چل رہی ہے۔ 2–3 سیکنڈ رک کر دوبارہ کوشش کریں۔' },
  'core.errValidationHint': { key: 'core.errValidationHint', en: 'Retrying will not help — correct the fields/values and save again.', roman: 'Retry se hal nahi hoga — fields/values durust kar ke dobara save karein.', ur: 'دوبارہ کوشش سے حل نہیں ہوگا — فیلڈز/ویلیوز درست کر کے دوبارہ محفوظ کریں۔' },
  'core.errUnknownHint': { key: 'core.errUnknownHint', en: 'Try again. If it persists, send a report via Support/Diagnose.', roman: 'Dobara koshish karein. Masla rahe to Support/Diagnose se report bhejein.', ur: 'دوبارہ کوشش کریں۔ مسئلہ رہے تو Support/Diagnose سے رپورٹ بھیجیں۔' },
  'core.saveAllTitle': { key: 'core.saveAllTitle', en: 'Save all unsaved changes on this page at once', roman: 'Is page ki saari unsaved tabdeeliyan ek sath save karein', ur: 'اس صفحے کی تمام غیر محفوظ تبدیلیاں ایک ساتھ محفوظ کریں' },
  'core.bootLoadFail': { key: 'core.bootLoadFail', en: 'Something did not load properly — try again', roman: 'Kuch theek se load nahi hua — dobara koshish karein', ur: 'کچھ ٹھیک سے لوڈ نہیں ہوا — دوبارہ کوشش کریں' },
  'core.runTimeout': { key: 'core.runTimeout', en: 'No response — you can try again', roman: 'Jawab nahi aaya — dobara koshish kar sakte hain', ur: 'جواب نہیں آیا — دوبارہ کوشش کر سکتے ہیں' },
  'core.dirtyTail': { key: 'core.dirtyTail', en: ' unsaved change(s) — save all at once', roman: ' unsaved tabdeeli — sab ek sath save karein', ur: ' غیر محفوظ تبدیلیاں — سب ایک ساتھ محفوظ کریں' },
  'core.syncDone': { key: 'core.syncDone', en: ' queued items synced ✅', roman: ' queued kaam sync ho gaye ✅', ur: ' قطار میں کام سنک ہو گئے ✅' },
  'core.chipAriaTail': { key: 'core.chipAriaTail', en: ' pending — sync now', roman: ' pending — abhi sync karein', ur: ' زیرِ التوا — ابھی سنک کریں' },
  'core.errAuth': { key: 'core.errAuth', en: 'Session / permission issue', roman: 'Session / ijazat ka masla', ur: 'سیشن / اجازت کا مسئلہ' },
  'core.errConflict': { key: 'core.errConflict', en: 'Another operation is running', roman: 'Doosra kaam chal raha hai', ur: 'کوئی اور کام چل رہا ہے' },
  'core.qFullPre': { key: 'core.qFullPre', en: 'Offline queue is full (', roman: 'Offline queue bhar gayi (', ur: 'آف لائن قطار بھر گئی (' },
  'core.noDirty': { key: 'core.noDirty', en: 'No unsaved changes', roman: 'Koi unsaved tabdeeli nahi', ur: 'کوئی غیر محفوظ تبدیلی نہیں' },
  'core.retryBtn': { key: 'core.retryBtn', en: '↻ Try again', roman: '↻ Dobara koshish karein', ur: '↻ دوبارہ کوشش کریں' },
  'core.errUnknown': { key: 'core.errUnknown', en: 'The operation did not complete', roman: 'Kaam mukammal nahi hua', ur: 'کام مکمل نہیں ہوا' },
  'core.errValidation': { key: 'core.errValidation', en: 'Fix the input', roman: 'Maloomat theek karein', ur: 'معلومات درست کریں' },
  'core.syncStatFail': { key: 'core.syncStatFail', en: ' failed (data mismatch)', roman: ' fail (data mismatch)', ur: ' ناکام (ڈیٹا مزمارچ)' },
  'core.chipTitleTail': { key: 'core.chipTitleTail', en: ' items awaiting sync', roman: ' kaam sync ka intezar', ur: ' کام سنک کا انتظار' },
  'core.qFullTail': { key: 'core.qFullTail', en: ') — sync required', roman: ') — sync zaroori hai', ur: ') — سنک ضروری ہے' },
  'core.resync': { key: 'core.resync', en: 'Sync again', roman: 'Dobara sync karein', ur: 'دوبارہ سنک کریں' },
  'core.errOffline': { key: 'core.errOffline', en: 'No internet', roman: 'Internet nahi hai', ur: 'انٹرنیٹ نہیں ہے' },
  'core.saveAllDone': { key: 'core.saveAllDone', en: 'Save-all complete', roman: 'Save all mukammal', ur: 'سیو آل مکمل' },
  'core.errServer': { key: 'core.errServer', en: 'Server problem', roman: 'Server par masla', ur: 'سرور پر مسئلہ' },
  'core.errTimeout': { key: 'core.errTimeout', en: 'No response', roman: 'Jawab nahi aaya', ur: 'جواب نہیں آیا' },
  'core.syncNow': { key: 'core.syncNow', en: 'Sync now', roman: 'Ab sync karein', ur: 'ابھی سنک کریں' },
  'core.noDataChart': { key: 'core.noDataChart', en: 'No data', roman: 'Koi data nahi', ur: 'کوئی ڈیٹا نہیں' },
  'core.syncStatMid': { key: 'core.syncStatMid', en: ' synced, ', roman: ' sync hue, ', ur: ' سنک ہوئے، ' },
  'aic.keySafety': { key: 'aic.keySafety', en: 'API key lives only in Script Properties — never in spreadsheet cells or browser storage.', roman: 'API key sirf Script Properties mein — spreadsheet cells ya browser storage mein kabhi nahi.', ur: 'اے پی آئی کی صرف اسکرپٹ پراپرٹیز میں — اسپریڈشیٹ سیلز یا براؤزر اسٹوریج میں کبھی نہیں۔' },
  'aic.localEngineTail': { key: 'aic.localEngineTail', en: ' — the app’s own LOCAL rules engine. No internet, no API key, no LLM.', roman: ' — app ka apna LOCAL rules engine. Koi internet, koi API key, koi LLM nahi.', ur: ' — ایپ کا اپنا لوکل رولز انجن۔ کوئی انٹرنیٹ، اے پی آئی کی یا ایل ایل ایم نہیں۔' },
  'aic.needsNet': { key: 'aic.needsNet', en: 'Will not work without internet (use the Local Data Assistant then)', roman: 'Internet ke bagair kaam nahi karega (us waqt Local Data Assistant chunein)', ur: 'انٹرنیٹ کے بغیر کام نہیں کرے گا (اس وقت لوکل ڈیٹا اسسٹنٹ چنیں)' },
  'aic.localEngine': { key: 'aic.localEngine', en: 'The app’s own LOCAL rules engine — no internet, no API key, no LLM.', roman: 'App ka apna LOCAL rules engine — koi internet, koi API key, koi LLM nahi.', ur: 'ایپ کا اپنا لوکل رولز انجن — کوئی انٹرنیٹ، اے پی آئی کی یا ایل ایل ایم نہیں۔' },
  'aic.modelDisclaimer': { key: 'aic.modelDisclaimer', en: 'Answers come from a model — mistakes are possible; double-check numbers', roman: 'Jawab model se aata hai — galti mumkin hai, numbers dobara check karein', ur: 'جواب ماڈل سے آتا ہے — غلطی ممکن ہے، نمبر دوبارہ چیک کریں' },
  'aic.demoHint': { key: 'aic.demoHint', en: 'Pick the Local Data Assistant for demo — Setup ▸ Provider.', roman: 'Demo ke liye Local Data Assistant chunein — Setup ▸ Provider.', ur: 'ڈیمو کے لیے لوکل ڈیٹا اسسٹنٹ چنیں — Setup ▸ Provider۔' },
  'aic.noKeyNeeded': { key: 'aic.noKeyNeeded', en: 'This provider needs no API key — server/local mode.', roman: 'Is provider ko API key ki zaroorat nahi — server/local mode.', ur: 'اس پرووائیڈر کو اے پی آئی کی ضرورت نہیں — سرور/لوکل موڈ۔' },
  'aic.noChat': { key: 'aic.noChat', en: 'No chat history yet (ask the first question).', roman: 'Abhi koi chat record nahi (pehla sawal poochein).', ur: 'ابھی کوئی چیٹ ریکارڈ نہیں (پہلا سوال پوچھیں)۔' },
  'aic.capabilities': { key: 'aic.capabilities', en: 'What this assistant can do — and cannot', roman: 'Ye assistant kya kar sakta hai — aur kya nahi', ur: 'یہ اسسٹنٹ کیا کر سکتا ہے — اور کیا نہیں' },
  'aic.canDraft': { key: 'aic.canDraft', en: 'Draft creation (posting/approval is done by a human)', roman: 'Draft banana (post/approve insaan karta hai)', ur: 'ڈرافٹ بنانا (پوسٹ/منظوری انسان کرتا ہے)' },
  'aic.cfgFail': { key: 'aic.cfgFail', en: 'Could not load AI config (backend offline?).', roman: 'AI config nahi mil saka (backend offline?).', ur: 'اے آئی کنفیگ لوڈ نہیں ہو سکا (بیک اینڈ آف لائن؟)۔' },
  'aic.questionChips': { key: 'aic.questionChips', en: 'Show question chips below the chat.', roman: 'Chat ke neeche sawal-chips dikhayein.', ur: 'چیٹ کے نیچے سوال چپس دکھائیں۔' },
  'aic.noBackendQ': { key: 'aic.noBackendQ', en: 'The backend cannot respond (offline?)', roman: 'Backend jawab nahi de saka (offline?)', ur: 'بیک اینڈ جواب نہیں دے سکتا (آف لائن؟)' },
  'aic.ollamaEndpoint': { key: 'aic.ollamaEndpoint', en: 'An endpoint is required for Ollama.', roman: 'Ollama ke liye endpoint lazmi hai.', ur: 'اولاما کے لیے اینڈ پوائنٹ لازمی ہے۔' },
  'aic.askPh': { key: 'aic.askPh', en: 'Type a question… (Enter to send)', roman: 'Sawal likhein… (Enter se bhejein)', ur: 'سوال لکھیں… (Enter سے بھیجیں)' },
  'aic.saved': { key: 'aic.saved', en: 'AI settings saved ✅', roman: 'AI settings mehfooz ho gayin ✅', ur: 'اے آئی سیٹنگز محفوظ ہو گئیں ✅' },
  'aic.noBackend': { key: 'aic.noBackend', en: 'The backend cannot respond.', roman: 'Backend jawab nahi de saka.', ur: 'بیک اینڈ جواب نہیں دے سکتا۔' },
  'aic.pasteKey': { key: 'aic.pasteKey', en: 'Paste the API key here', roman: 'API key yahan paste karein', ur: 'اے پی آئی کی یہاں پیسٹ کریں' },
  'aic.unsaved': { key: 'aic.unsaved', en: 'Unsaved changes', roman: 'Gair-mehfooz tabdeeliyan', ur: 'غیر محفوظ تبدیلیاں' },
  'aic.retry': { key: 'aic.retry', en: 'Try again', roman: 'Dobara koshish karein', ur: 'دوبارہ کوشش کریں' },
  'aic.removeKey': { key: 'aic.removeKey', en: 'Remove stored key', roman: 'Mehfooz key hata dein', ur: 'محفوظ کی ہٹا دیں' },
  'aic.allSaved': { key: 'aic.allSaved', en: 'Everything is saved', roman: 'Sab kuch mehfooz hai', ur: 'سب کچھ محفوظ ہے' },
  'aic.approvalReq': { key: 'aic.approvalReq', en: 'Approval required', roman: 'Approval zaroori', ur: 'منظوری ضروری' },
  'aic.openSetup': { key: 'aic.openSetup', en: 'Open AI Setup', roman: 'AI Setup kholein', ur: 'اے آئی سیٹ اپ کھولیں' },
  'aic.cannot': { key: 'aic.cannot', en: '✖ Cannot', roman: '✖ Nahi kar sakta', ur: '✖ نہیں کر سکتا' },
  'aic.pickFromList': { key: 'aic.pickFromList', en: 'Pick from the list', roman: 'List se chunein', ur: 'فہرست سے چنیں' },
  'aic.readAgain': { key: 'aic.readAgain', en: 'Read again', roman: 'Dobara parein', ur: 'دوبارہ پڑھیں' },
  'aic.setupReq': { key: 'aic.setupReq', en: 'Setup required', roman: 'Setup zaroori', ur: 'سیٹ اپ ضروری' },
  'aic.send': { key: 'aic.send', en: 'Send', roman: 'Bhejein', ur: 'بھیجیں' },
  'cfg.repairNote': { key: 'cfg.repairNote', en: 'These columns are written by code but missing in the sheet — data may drop silently. Repair never deletes data; it only adds columns.', roman: 'Ye columns code likhta hai par sheet mein nahi — data silently drop ho sakta hai. Repair se data delete nahi hota, sirf columns judte hain.', ur: 'یہ کالم کوڈ لکھتا ہے مگر شیٹ میں نہیں — ڈیٹا خاموشی سے گر سکتا ہے۔ ریپئر سے ڈیٹا ڈیلیٹ نہیں ہوتا، صرف کالم جڑتے ہیں۔' },
  'cfg.idempotentNote': { key: 'cfg.idempotentNote', en: 'This is idempotent — re-running creates no duplicates and deletes no rows.', roman: 'Yeh idempotent hai — dobara chalane se duplicate nahi banta, koi row delete nahi hoti.', ur: 'یہ idempotent ہے — دوبارہ چلانے سے ڈپلیکیٹ نہیں بنتا، کوئی قطار ڈیلیٹ نہیں ہوتی۔' },
  'cfg.freeModeHint': { key: 'cfg.freeModeHint', en: 'Free mode (LINK): no API key — WhatsApp opens via a wa.me link. ', roman: 'Free mode (LINK): koi API key nahi — wa.me link se WhatsApp khul jata hai. ', ur: 'فری موڈ (LINK): کوئی API key نہیں — wa.me لنک سے واٹس ایپ کھلتا ہے۔ ' },
  'cfg.installJobsHint': { key: 'cfg.installJobsHint', en: 'Tap “Install jobs” — then allow Google authorization.', roman: '“Install jobs” dabayein — phir Google authorization allow karein.', ur: '“Install jobs” دبائیں — پھر گوگل اجازت دیں۔' },
  'cfg.pasteHint': { key: 'cfg.pasteHint', en: 'Items, customers or suppliers — paste from Sheet/Excel.', roman: 'Items, customers ya suppliers — Sheet/Excel se paste karein.', ur: 'آئٹمز، کسٹمرز یا سپلائرز — شیٹ/ایکسل سے پیسٹ کریں۔' },
  'cfg.menuRestore': { key: 'cfg.menuRestore', en: 'Restore the default menu? The custom menu will be deleted.', roman: 'Default menu restore karein? Custom menu delete ho jayega.', ur: 'ڈیفالٹ مینو بحال کریں؟ کسٹم مینو ڈیلیٹ ہو جائے گا۔' },
  'cfg.livePreviewHint': { key: 'cfg.livePreviewHint', en: '(the whole app will look like this — no save needed)', roman: '(poori app aise hi dikhaye gi — save ki zaroorat nahi)', ur: '(پوری ایپ ایسے ہی دکھے گی — محفوظ کرنے کی ضرورت نہیں)' },
  'cfg.schemaFail': { key: 'cfg.schemaFail', en: 'Schema failed to load — check the backend deploy', roman: 'Schema load nahi hua — backend deploy check karein', ur: 'اسکیما لوڈ نہیں ہوئی — بیک اینڈ ڈیپلائے چیک کریں' },
  'cfg.noUnsaved': { key: 'cfg.noUnsaved', en: 'No unsaved changes — everything is saved', roman: 'Koi unsaved tabdeeli nahi — sab mehfooz hai', ur: 'کوئی غیر محفوظ تبدیلی نہیں — سب محفوظ ہے' },
  'cfg.noTemplates': { key: 'cfg.noTemplates', en: 'No templates — create one with the button above', roman: 'Koi template nahi — upar button se banayein', ur: 'کوئی ٹیمپلیٹ نہیں — اوپر کے بٹن سے بنائیں' },
  'cfg.noChanges': { key: 'cfg.noChanges', en: 'No changes — everything is already saved', roman: 'Koi tabdeeli nahi — sab pehle se save hai', ur: 'کوئی تبدیلی نہیں — سب پہلے سے محفوظ ہے' },
  'cfg.stockUntouched': { key: 'cfg.stockUntouched', en: 'Existing item stock is not touched', roman: 'Maujuda items ka stock chera nahi jata', ur: 'موجودہ آئٹمز کا اسٹاک نہیں چھیڑا جاتا' },
  'cfg.restoreDefaults': { key: 'cfg.restoreDefaults', en: 'Restore defaults for this tab?', roman: 'Is tab ke defaults restore karein?', ur: 'اس ٹیب کے ڈیفالٹس بحال کریں؟' },
  'cfg.screenReq': { key: 'cfg.screenReq', en: 'Screen id and label are required', roman: 'Screen id aur label zaroori hain', ur: 'اسکرین آئی ڈی اور لیبل ضروری ہیں' },
  'cfg.pasteJson': { key: 'cfg.pasteJson', en: 'Paste config JSON here', roman: 'Yahan config JSON paste karein', ur: 'یہاں کنفیگ JSON پیسٹ کریں' },
  'cfg.noWriteTail': { key: 'cfg.noWriteTail', en: ' update (no writes)', roman: ' update (koi write nahi hua)', ur: ' اپ ڈیٹ (کوئی رائٹ نہیں ہوا)' },
  'cfg.noImports': { key: 'cfg.noImports', en: 'No imports yet', roman: 'Abhi koi import nahi hua', ur: 'ابھی کوئی امپورٹ نہیں ہوا' },
  'cfg.noJobs': { key: 'cfg.noJobs', en: 'No jobs installed', roman: 'Koi job install nahi hai', ur: 'کوئی جاب انسٹال نہیں' },
  'cfg.savedCount': { key: 'cfg.savedCount', en: ' setting(s) saved ✅', roman: ' setting save ho gayi ✅', ur: ' سیٹنگ محفوظ ہو گئی ✅' },
  'cfg.templateDeleteConfirm': { key: 'cfg.templateDeleteConfirm', en: 'Delete this template?', roman: 'Template delete karein?', ur: 'ٹیمپلیٹ ڈیلیٹ کریں؟' },
  'cfg.templateDeleted': { key: 'cfg.templateDeleted', en: 'Template deleted', roman: 'Template delete ho gaya', ur: 'ٹیمپلیٹ ڈیلیٹ ہو گیا' },
  'cfg.logoDone': { key: 'cfg.logoDone', en: 'Logo uploaded ✅', roman: 'Logo upload ho gaya ✅', ur: 'لوگو اپ لوڈ ہو گیا ✅' },
  'cfg.retryTail': { key: 'cfg.retryTail', en: ', please try again', roman: 'dobara koshish karein', ur: 'دوبارہ کوشش کریں' },
  'cfg.noPoints': { key: 'cfg.noPoints', en: 'No points earned', roman: 'Koi points nahi mile', ur: 'کوئی پوائنٹس نہیں ملے' },
  'cfg.planCopied': { key: 'cfg.planCopied', en: 'Plan copied', roman: 'Plan copy ho gaya', ur: 'پلان کاپی ہو گیا' },
  'cfg.labelReq': { key: 'cfg.labelReq', en: 'Label is required', roman: 'Label zaroori hai', ur: 'لیبل ضروری ہے' },
  'cfg.jsonBad': { key: 'cfg.jsonBad', en: 'Invalid JSON: ', roman: 'JSON ghalat hai: ', ur: 'جے سون غلط ہے: ' },
  'cfg.nameReq': { key: 'cfg.nameReq', en: 'Name is required', roman: 'Name zaroori hai', ur: 'نام ضروری ہے' },
  'cfg.repaired': { key: 'cfg.repaired', en: 'Repaired: ', roman: 'Repair ho gaya: ', ur: 'ریپئر ہو گیا: ' },
  'cfg.noLogo': { key: 'cfg.noLogo', en: '🖼 No logo', roman: '🖼 Koi logo nahi', ur: '🖼 کوئی لوگو نہیں' },
  'cfg.saveFail': { key: 'cfg.saveFail', en: 'Could not save: ', roman: 'Save nahi hua: ', ur: 'محفوظ نہیں ہوا: ' },
  'cfg.jsonBadShort': { key: 'cfg.jsonBadShort', en: 'Invalid JSON', roman: 'JSON ghalat hai', ur: 'جے سون غلط ہے' },
  'cfg.saveFailShort': { key: 'cfg.saveFailShort', en: 'Could not save', roman: 'Save nahi hua', ur: 'محفوظ نہیں ہوا' },
  'cfg.priceDiffTail': { key: 'cfg.priceDiffTail', en: ' price difference', roman: ' price farq', ur: ' قیمت فرق' },
  'cfg.rateDiff': { key: 'cfg.rateDiff', en: 'Rate difference: ', roman: 'Rate farq: ', ur: 'ریٹ فرق: ' },
  'dash.openingFloatHint': { key: 'dash.openingFloatHint', en: 'Enter drawer opening cash (float) at day start. Expected vs counted variance is computed at day-end.', roman: 'Din shuru karte waqt drawer ki opening cash (float) darj karein. Day-end par expected vs counted ka farq khud nikal aayega.', ur: 'دن شروع کرتے وقت دراز کی اوپننگ کیش (فلوٹ) درج کریں۔ دن کے اختتام پر متوقع بمقابلہ گنی گئی کا فرق خود نکل آئے گا۔' },
  'dash.termsHint': { key: 'dash.termsHint', en: 'Paying on terms improves relationships and discount terms.', roman: 'Payment terms ke mutabiq clearing se relationship aur discount terms behtar hoti hain.', ur: 'ادائیگی شرائط کے مطابق ہو تو تعلقات اور ڈسکاؤنٹ شرائط بہتر ہوتے ہیں۔' },
  'dash.recoveryHint': { key: 'dash.recoveryHint', en: 'Plan recoveries with customers; follow up on older invoices first.', roman: 'Customers se recovery ka plan banaayein; purani invoices pehle follow up karein.', ur: 'کسٹمرز کے ساتھ وصولی کا منصوبہ بنائیں؛ پرانی انوائسز کا پیچھا پہلے کریں۔' },
  'dash.noAutoReport': { key: 'dash.noAutoReport', en: 'No auto report yet — it appears here after shop open/close', roman: 'Abhi koi auto report nahi — shop open/close karte hi yahan aa jayegi', ur: 'ابھی کوئی آٹو رپورٹ نہیں — دکان کھولنے/بند کرتے ہی یہاں آ جائے گی' },
  'dash.alertsHint': { key: 'dash.alertsHint', en: 'Check low-stock, expiry and credit alerts now.', roman: 'Low stock, expiry aur udhaar ki alerts abhi check karein.', ur: 'کم اسٹاک، ایکسپائری اور ادھار کے الرٹس ابھی چیک کریں۔' },
  'dash.wizardRerun': { key: 'dash.wizardRerun', en: '🧭 Run setup wizard again', roman: '🧭 Setup wizard dobara chalayen · دوبارہ سیٹ اپ', ur: '🧭 سیٹ اپ وزرڈ دوبارہ چلائیں' },
  'dash.popupBlocked': { key: 'dash.popupBlocked', en: 'Popup blocked — allow it in the browser', roman: 'Popup blocked — browser se allow karein', ur: 'پاپ اپ بلاک — براؤزر میں اجازت دیں' },
  'dash.noPaymentsRange': { key: 'dash.noPaymentsRange', en: 'No payments in this range', roman: 'Is range me koi payment nahi', ur: 'اس رینج میں کوئی ادائیگی نہیں' },
  'dash.reportsFail': { key: 'dash.reportsFail', en: 'Reports could not load', roman: 'Reports load nahi ho sakeen', ur: 'رپورٹس لوڈ نہیں ہو سکیں' },
  'dash.shopCloseConfirm': { key: 'dash.shopCloseConfirm', en: 'Close the shop? Counted ', roman: 'Shop close karein? Counted ', ur: 'دکان بند کریں؟ گنی گئی ' },
  'dash.noSalesRange': { key: 'dash.noSalesRange', en: 'No sales in this range', roman: 'Is range me koi sale nahi', ur: 'اس رینج میں کوئی سیل نہیں' },
  'dash.noPrevSessions': { key: 'dash.noPrevSessions', en: 'No previous sessions', roman: 'Koi purani session nahi', ur: 'کوئی پچھلا سیشن نہیں' },
  'dash.receivablesCard': { key: 'dash.receivablesCard', en: '📒 Credit (receivables)', roman: '📒 Udhaar (receivables)', ur: '📒 وصولی (ادھار)' },
  'dash.noCashMoves': { key: 'dash.noCashMoves', en: 'No cash movements', roman: 'Koi cash movement nahi', ur: 'کوئی کیش موومنٹ نہیں' },
  'dash.prevUdhaarPrev': { key: 'dash.prevUdhaarPrev', en: 'Previous credit (prev)', roman: 'Pichhla udhaar (prev)', ur: 'پچھلا ادھار (سابقہ)' },
  'dash.prevBalPrev': { key: 'dash.prevBalPrev', en: 'Previous balance (prev)', roman: 'Pichhla baqaya (prev)', ur: 'پچھلا بقایا (سابقہ)' },
  'dash.noPaymentsYet': { key: 'dash.noPaymentsYet', en: 'No payments yet', roman: 'Abhi koi payment nahi', ur: 'ابھی کوئی ادائیگی نہیں' },
  'dash.creditGiven': { key: 'dash.creditGiven', en: 'Credit (given)', roman: 'Udhaar (credit given)', ur: 'ادھار (دیا گیا)' },
  'dash.customerUdhaar': { key: 'dash.customerUdhaar', en: 'Customer-wise credit', roman: 'Customer-wise udhaar', ur: 'کسٹمر کے حساب ادھار' },
  'dash.reportFail': { key: 'dash.reportFail', en: 'Could not create report', roman: 'Report nahi ban saki', ur: 'رپورٹ نہیں بن سکی' },
  'dash.csvDone': { key: 'dash.csvDone', en: 'CSV downloaded', roman: 'CSV download ho gayi', ur: 'سی ایس وی ڈاؤن لوڈ ہو گئی' },
  'dash.reportLoadFail': { key: 'dash.reportLoadFail', en: 'Report failed to load', roman: 'Report load nahi hua', ur: 'رپورٹ لوڈ نہیں ہوا' },
  'dash.receivableKpi': { key: 'dash.receivableKpi', en: 'Credit (receivable)', roman: 'Udhaar (receivable)', ur: 'وصول کے لیے ادھار' },
  'dash.maxUdhaar': { key: 'dash.maxUdhaar', en: 'Highest credit', roman: 'Sabse zyada udhaar', ur: 'سب سے زیادہ ادھار' },
  'dash.shareFail': { key: 'dash.shareFail', en: 'Could not share', roman: 'Share nahi ho saka', ur: 'شیئر نہیں ہو سکا' },
  'dash.enterAmount': { key: 'dash.enterAmount', en: 'Enter the amount', roman: 'Amount darj karein', ur: 'رقم درج کریں' },
  'dash.noUdhaar': { key: 'dash.noUdhaar', en: 'No credit outstanding 🎉', roman: 'Koi udhaar nahi 🎉', ur: 'کوئی ادھار باقی نہیں 🎉' },
  'dash.wizardFail': { key: 'dash.wizardFail', en: 'Wizard did not open', roman: 'Wizard nahi khula', ur: 'وزرڈ کھلا نہیں' },
  'dash.receiveUdhaar': { key: 'dash.receiveUdhaar', en: '💰 Receive credit', roman: '💰 Receive udhaar', ur: '💰 ادھار وصول کریں' },
  'dash.udhaarCustomers': { key: 'dash.udhaarCustomers', en: 'Credit customers', roman: 'Udhaar customers', ur: 'ادھار کسٹمرز' },
  'dash.noNumber': { key: 'dash.noNumber', en: 'Number not found', roman: 'Number nahi mila', ur: 'نمبر نہیں ملا' },
  'dash.recovery': { key: 'dash.recovery', en: 'Credit recovery', roman: 'Udhaar recovery', ur: 'ادھار وصولی' },
  'dash.udhaarOutstanding': { key: 'dash.udhaarOutstanding', en: ' credit outstanding', roman: ' udhaar baqaya', ur: ' ادھار باقی' },
  'dash.prevBal': { key: 'dash.prevBal', en: 'Previous balance', roman: 'Pichhla baqaya', ur: 'پچھلا بقایا' },
  'dash.sendReport': { key: 'dash.sendReport', en: 'Send report', roman: 'Report bhejein', ur: 'رپورٹ بھیجیں' },
  'dash.csvFail': { key: 'dash.csvFail', en: 'Could not create CSV', roman: 'CSV nahi bana', ur: 'سی ایس وی نہیں بنا' },
  'dash.totalUdhaar': { key: 'dash.totalUdhaar', en: 'Total credit', roman: 'Total udhaar', ur: 'کل ادھار' },
  'dash.withUdhaar': { key: 'dash.withUdhaar', en: 'With credit', roman: 'With udhaar', ur: 'ادھار پر' },
  'dash.newUdhaar': { key: 'dash.newUdhaar', en: 'New credit', roman: 'Naya udhaar', ur: 'نیا ادھار' },
  'dash.noData': { key: 'dash.noData', en: 'No data', roman: 'Data nahi', ur: 'کوئی ڈیٹا نہیں' },
  'dash.collections': { key: 'dash.collections', en: 'Collections', roman: 'Wasooli', ur: 'وصولی' },
  'cfg.repairNote': { key: 'cfg.repairNote', en: 'These columns are written by code but missing in the sheet — data may drop silently. Repair never deletes data; it only adds columns.', roman: 'Ye columns code likhta hai par sheet mein nahi — data silently drop ho sakta hai. Repair se data delete nahi hota, sirf columns judte hain.', ur: 'یہ کالم کوڈ لکھتا ہے مگر شیٹ میں نہیں — ڈیٹا خاموشی سے گر سکتا ہے۔ ریپئر سے ڈیٹا ڈیلیٹ نہیں ہوتا، صرف کالم جڑتے ہیں۔' },
  'cfg.idempotentNote': { key: 'cfg.idempotentNote', en: 'This is idempotent — re-running creates no duplicates and deletes no rows.', roman: 'Yeh idempotent hai — dobara chalane se duplicate nahi banta, koi row delete nahi hoti.', ur: 'یہ idempotent ہے — دوبارہ چلانے سے ڈپلیکیٹ نہیں بنتا، کوئی قطار ڈیلیٹ نہیں ہوتی۔' },
  'cfg.freeModeHint': { key: 'cfg.freeModeHint', en: 'Free mode (LINK): no API key — WhatsApp opens via a wa.me link. ', roman: 'Free mode (LINK): koi API key nahi — wa.me link se WhatsApp khul jata hai. ', ur: 'فری موڈ (LINK): کوئی API key نہیں — wa.me لنک سے واٹس ایپ کھلتا ہے۔ ' },
  'cfg.installJobsHint': { key: 'cfg.installJobsHint', en: 'Tap “Install jobs” — then allow Google authorization.', roman: '“Install jobs” dabayein — phir Google authorization allow karein.', ur: '“Install jobs” دبائیں — پھر گوگل اجازت دیں۔' },
  ...
  'cfg.priceDiffTail': { key: 'cfg.priceDiffTail', en: ' price difference', roman: ' price farq', ur: ' قیمت فرق' },
  'cfg.rateDiff': { key: 'cfg.rateDiff', en: 'Rate difference: ', roman: 'Rate farq: ', ur: 'ریٹ فرق: ' },
  'acc.ledgerHint': { key: 'acc.ledgerHint', en: 'Pick any account — its ledger (opening → entries → closing) opens in a popup.', roman: 'Koi bhi account chunein — uska ledger (opening → entries → closing) popup mein khulega.', ur: 'کوئی بھی اکاؤنٹ چنیں — اس کا لیجر (اوپننگ → انٹریز → کلوزنگ) پاپ اپ میں کھلے گا۔' },
  'acc.vfdIntro': { key: 'acc.vfdIntro', en: 'Sales, GRNs, payments and expenses created earlier that have no voucher yet — ', roman: 'Jo sales, GRN, payments aur expenses pehle banaye gaye the aur unka voucher nahi bana, ', ur: 'وہ سیلز، جی آر این، ادائیگیاں اور اخراجات جو پہلے بنائے گئے تھے اور ان کا واؤچر نہیں بنا — ' },
  'acc.vfdMid': { key: 'acc.vfdMid', en: 'vouchers will now be created for all of them. This is a one-time job — re-running it ', roman: 'un sab ke liye abhi vouchers ban jayenge. Ye ek baar ka kaam hai — dobara chalane par ', ur: 'ان سب کے لیے ابھی واؤچر بن جائیں گے۔ یہ ایک بار کا کام ہے — دوبارہ چلانے پر ' },
  'acc.csvPasteHint': { key: 'acc.csvPasteHint', en: 'Paste CSV: date, reference, amount, direction (IN/OUT). Negative amount = OUT.', roman: 'CSV paste karein: date, reference, amount, direction (IN/OUT). Negative amount = OUT.', ur: 'سی ایس وی پیسٹ کریں: تاریخ، حوالہ، رقم، سمت (IN/OUT)۔ منفی رقم = OUT۔' },
  'acc.vfdRule': { key: 'acc.vfdRule', en: 'Sale → Dr Cash/Bank + Dr Credit, Cr Sales · GRN → Dr Purchase, Cr Supplier · ', roman: 'Sale → Dr Cash/Bank + Dr Udhaar, Cr Sales · GRN → Dr Purchase, Cr Supplier · ', ur: 'سیل → ڈی کیش/بینک + ڈی ادھار، کریڈٹ سیل · جی آر این → ڈی خریداری، کریڈٹ سپلائر · ' },

  'acc.noVouchersYet': { key: 'acc.noVouchersYet', en: 'No vouchers yet — start with "New voucher" above', roman: 'Abhi koi voucher nahi — upar "New voucher" se shuru karein', ur: 'ابھی کوئی واؤچر نہیں — اوپر "نیا واؤچر" سے شروع کریں' },
  'acc.noStmtImport': { key: 'acc.noStmtImport', en: 'No statements imported — tap "Import statement"', roman: 'Koi statement import nahi hua — "Import statement" dabayein', ur: 'کوئی سٹیٹمنٹ امپورٹ نہیں ہوا — "Import statement" دبائیں' },

  'pwa.scannerTip': { key: 'pwa.scannerTip', en: 'Tip: the same scanner UI in every PWA — to grant camera access, browser Settings → Site → Camera → Allow.', roman: 'Tip: Same scanner UI har PWA me — camera permission dena ho to browser Settings → Site → Camera Allow karein.', ur: 'ٹپ: ہر PWA میں ایک ہی اسکینر UI — کیمرہ اجازت کے لیے براؤزر Settings → Site → Camera → Allow کریں۔' },
  'pwa.writeStaleTail': { key: 'pwa.writeStaleTail', en: ' was done \u2014 refresh the list first to check whether it already went through, then retry.', roman: ' ka kaam tha \u2014 pehle list refresh kar ke dekhein ke kaam ho chuka hai ya nahi, phir dobara karein.', ur: ' کا کام تھا — پہلے فہرست ریفرش کر کے دیکھیں کہ کام ہو چکا ہے یا نہیں، پھر دوبارہ کریں۔' },
  'pwa.noCamScan': { key: 'pwa.noCamScan', en: 'Camera scan is not available on this device — type the code below or upload a photo.', roman: 'Is device par camera scan available nahi — neeche code type karein ya photo upload karein.', ur: 'اس ڈیوائس پر کیمرہ اسکین دستیاب نہیں — نیچے کوڈ ٹائپ کریں یا تصویر اپ لوڈ کریں۔' },
  'pwa.backendUnreachable': { key: 'pwa.backendUnreachable', en: 'Backend not reachable — check Settings → Backend URL / use the offline queue', roman: 'Backend not reachable — Settings → Backend URL check karein / offline queue use karein', ur: 'بیک اینڈ تک رسائی نہیں — سیٹنگز → بیک اینڈ یو آر ایل چیک کریں / آف لائن قطار استعمال کریں' },
  'pwa.camBlocked': { key: 'pwa.camBlocked', en: 'Camera permission is blocked or unavailable — use a manual code or a photo.', roman: 'Camera permission blocked ya available nahi — manual code ya photo se scan karein.', ur: 'کیمرہ اجازت بلاک یا غیر دستیاب — دستی کوڈ یا تصویر سے اسکین کریں۔' },
  'pwa.connBackHint': { key: 'pwa.connBackHint', en: 'Try again when the connection returns; the offline queue will be used automatically.', roman: 'Connection wapas aane par dobara koshish karein; offline queue khud istemal hogi.', ur: 'کنکشن واپس آئے تو دوبارہ کوشش کریں؛ آف لائن قطار خود استعمال ہو گی۔' },
  'pwa.serverTimeout': { key: 'pwa.serverTimeout', en: 'No timely response from the server \u2014 try again.', roman: 'Server se jawab waqt par nahi mila \u2014 dobara koshish karein.', ur: 'سرور سے جواب وقت پر نہیں ملا — دوبارہ کوشش کریں۔' },
  'pwa.retrySupport': { key: 'pwa.retrySupport', en: 'Try again; if it persists, contact support.', roman: 'Dobara koshish karein; masla rahe to support ko batayein.', ur: 'دوبارہ کوشش کریں؛ مسئلہ رہے تو سپورٹ کو بتائیں۔' },
  'pwa.retryCheckLog': { key: 'pwa.retryCheckLog', en: 'Try again; if it persists, check the system log.', roman: 'Dobara koshish karein; masla rahe to system log dekhein.', ur: 'دوبارہ کوشش کریں؛ مسئلہ رہے تو سسٹم لاگ دیکھیں۔' },
  'pwa.photoDecodeFail': { key: 'pwa.photoDecodeFail', en: 'This browser cannot decode the photo — type the code manually', roman: 'Is browser me photo decode nahi — manual code likhein', ur: 'اس براؤزر میں تصویر ڈی کوڈ نہیں — دستی کوڈ لکھیں' },
  'pwa.noAnswerRetry': { key: 'pwa.noAnswerRetry', en: 'No response \u2014 you can try again', roman: 'Jawab nahi aaya \u2014 dobara koshish kar sakte hain', ur: 'جواب نہیں آیا — دوبارہ کوشش کر سکتے ہیں' },
  'pwa.retryWontHelp': { key: 'pwa.retryWontHelp', en: 'Retrying will not help \u2014 correct the fields.', roman: 'Retry se hal nahi hoga \u2014 fields durust karein.', ur: 'دوبارہ کوشش سے حل نہیں ہوگا — فیلڈز درست کریں۔' },
  'pwa.networkError': { key: 'pwa.networkError', en: 'Network error — check the backend URL or your connection', roman: 'Network error — backend URL ya net check karein', ur: 'نیٹ ورک ایرر — بیک اینڈ یو آر ایل یا نیٹ چیک کریں' },
  'pwa.noCodeInPhoto': { key: 'pwa.noCodeInPhoto', en: 'No code found in the photo — type it manually below', roman: 'Photo se code nahi mila — neeche manual likhein', ur: 'تصویر میں کوڈ نہیں ملا — نیچے دستی لکھیں' },
  'pwa.wait2sRetry': { key: 'pwa.wait2sRetry', en: 'Wait 2\u20133 seconds and try again.', roman: '2\u20133 second ruk kar dobara koshish karein.', ur: '2–3 سیکنڈ رک کر دوبارہ کوشش کریں۔' },
  'pwa.offlineRetry': { key: 'pwa.offlineRetry', en: 'Offline — try again when the network returns (', roman: 'Offline — net aane par dobara koshish karein (', ur: 'آف لائن — نیٹ آنے پر دوبارہ کوشش کریں (' },
  'pwa.installHint': { key: 'pwa.installHint', en: 'Add to home screen — faster and offline', roman: 'Home screen par add karein — tez aur offline', ur: 'ہوم اسکرین پر شامل کریں — تیز اور آف لائن' },
  'pwa.queueFull': { key: 'pwa.queueFull', en: 'Offline queue is full — sync first', roman: 'Offline queue bhar gayi — pehle sync karein', ur: 'آف لائن قطار بھر گئی — پہلے سنک کریں' },
  'pwa.noItemSelected': { key: 'pwa.noItemSelected', en: 'No item selected — scan or tick', roman: 'Koi item select nahi — scan ya tick karein', ur: 'کوئی آئٹم منتخب نہیں — اسکین یا ٹک کریں' },
  'pwa.reloginHint': { key: 'pwa.reloginHint', en: 'Log in again or ask the admin.', roman: 'Dobara login karein ya admin se poochein.', ur: 'دوبارہ لاگ ان کریں یا ایڈمن سے پوچھیں۔' },
  'pwa.noItemFound': { key: 'pwa.noItemFound', en: 'No item found — change the search', roman: 'Koi item nahi mila — search badlein', ur: 'کوئی آئٹم نہیں ملا — تلاش بدلیں' },
  'pwa.cameraScan': { key: 'pwa.cameraScan', en: 'Scan barcode with camera', roman: 'Camera se barcode scan karein', ur: 'کیمرے سے بارکوڈ اسکین کریں' },
  'pwa.retryBtn': { key: 'pwa.retryBtn', en: '\u21BB Try again', roman: '\u21BB Dobara koshish karein', ur: '↻ دوبارہ کوشش کریں' },
  'pwa.noNotifSupport': { key: 'pwa.noNotifSupport', en: 'Notifications not supported', roman: 'Notifications supported nahi', ur: 'نوٹیفکیشنز سپورٹڈ نہیں' },
  'pwa.scanEnterCode': { key: 'pwa.scanEnterCode', en: '📷 Scan — enter code', roman: '📷 Scan — Code enter karein', ur: '📷 اسکین — کوڈ درج کریں' },
  'pwa.openExtScanner': { key: 'pwa.openExtScanner', en: '↗ Open external scanner', roman: '↗ External scanner kholein', ur: '↗ بیرونی اسکینر کھولیں' },
  'pwa.multiMatchesTail': { key: 'pwa.multiMatchesTail', en: ' matches — pick from the list', roman: ' matches — list se chunein', ur: ' میچز — فہرست سے چنیں' },
  'pwa.sessionIssue': { key: 'pwa.sessionIssue', en: 'Session / permission issue', roman: 'Session / ijazat ka masla', ur: 'سیشن / اجازت کا مسئلہ' },
  'pwa.opIncomplete': { key: 'pwa.opIncomplete', en: 'The operation did not complete', roman: 'Kaam mukammal nahi hua', ur: 'کام مکمل نہیں ہوا' },
  'pwa.nothingToSync': { key: 'pwa.nothingToSync', en: 'Nothing to sync', roman: 'Sync ke liye kuch nahi', ur: 'سنک کے لیے کچھ نہیں' },
  'pwa.fixInput': { key: 'pwa.fixInput', en: 'Fix the input', roman: 'Maloomat theek karein', ur: 'معلومات درست کریں' },
  'pwa.photoFail': { key: 'pwa.photoFail', en: 'Photo failed to load', roman: 'Photo load nahi hui', ur: 'تصویر لوڈ نہیں ہوئی' },
  'pwa.noInternet': { key: 'pwa.noInternet', en: 'No internet', roman: 'Internet nahi hai', ur: 'انٹرنیٹ نہیں ہے' },
  'pwa.noNetYet': { key: 'pwa.noNetYet', en: 'No network right now', roman: 'Abhi net nahi hai', ur: 'ابھی نیٹ نہیں ہے' },
  'pwa.noCustomer': { key: 'pwa.noCustomer', en: 'No customer', roman: 'Koi customer nahi', ur: 'کوئی کسٹمر نہیں' },
  'pwa.codeNotFound': { key: 'pwa.codeNotFound', en: 'Code not found: ', roman: 'Code nahi mila: ', ur: 'کوڈ نہیں ملا: ' },
  'pwa.noAnswer': { key: 'pwa.noAnswer', en: 'No response', roman: 'Jawab nahi aaya', ur: 'جواب نہیں آیا' },
  'pwa.close': { key: 'pwa.close', en: 'Close', roman: 'Band karein', ur: 'بند کریں' },
  'pwh.poAutoHint': { key: 'pwh.poAutoHint', en: 'Pick a PO → expected items auto-load into the GRN cart. Then match actual counted qty and confirm the GRN.', roman: 'PO chunein → expected items GRN cart mein auto-load. Phir actual counted qty match karke GRN confirm karein.', ur: 'پی او چنیں → متوقع آئٹمز جی آر این کارٹ میں آٹو لوڈ۔ پھر اصل گنی گئی qty ملا کر جی آر این کنفرم کریں۔' },
  'pwh.scanLineHint': { key: 'pwh.scanLineHint', en: 'Lines can also be filled by scanning — use the scanner below.', roman: 'Scan se bhi line bhari ja sakti hai — neeche scanner use karein.', ur: 'اسکین سے بھی لائن بھری جا سکتی ہے — نیچے اسکینر استعمال کریں۔' },
  'pwh.clearCounted': { key: 'pwh.clearCounted', en: 'Clear locally counted values? (server values remain)', roman: 'Local counted values clear karein? (server values rahenge)', ur: 'مقامی گنی گئی ویلیوز صاف کریں؟ (سرور ویلیوز رہیں گی)' },
  'pwh.poInCartTail': { key: 'pwh.poInCartTail', en: ' PO items in the cart — verify and save the GRN', roman: ' PO items cart mein — verify karke GRN save karein', ur: ' پی او آئٹمز کارٹ میں — تصدیق کر کے جی آر این محفوظ کریں' },
  'pwh.notInPo': { key: 'pwh.notInPo', en: 'This item is not in the PO — adding it anyway', roman: 'Ye item PO mein nahi — phir bhi add kar rahe hain', ur: 'یہ آئٹم پی او میں نہیں — پھر بھی شامل کر رہے ہیں' },
  'pwh.notInSheet': { key: 'pwh.notInSheet', en: 'This item is not in the sheet — check the filter', roman: 'Ye item is sheet mein nahi — filter check karein', ur: 'یہ آئٹم اس شیٹ میں نہیں — فلٹر چیک کریں' },
  'pwh.makeSheetHint': { key: 'pwh.makeSheetHint', en: 'Create a sheet in ERP ▸ Inventory ▸ Count sheet', roman: 'ERP ▸ Inventory ▸ Count sheet se sheet banayein', ur: 'ای آر پی ▸ انوینٹری ▸ کاؤنٹ شیٹ سے شیٹ بنائیں' },
  'pwh.noItem': { key: 'pwh.noItem', en: 'No item found — check the code or name', roman: 'Koi item nahi mila — code ya naam check karein', ur: 'کوئی آئٹم نہیں ملا — کوڈ یا نام چیک کریں' },
  'pwh.emptyYet': { key: 'pwh.emptyYet', en: 'Nothing yet — load a PO or scan', roman: 'Abhi kuch nahi — PO load karein ya scan karein', ur: 'ابھی کچھ نہیں — پی او لوڈ کریں یا اسکین کریں' },
  'pwh.notInPoConfirm': { key: 'pwh.notInPoConfirm', en: ' item(s) not in the PO — still post the GRN?', roman: ' item(s) PO mein nahi — phir bhi GRN karein?', ur: ' آئٹم(ز) پی او میں نہیں — پھر بھی جی آر این کریں؟' },
  'pwh.loadPoFirst': { key: 'pwh.loadPoFirst', en: 'Load a PO first or scan an item', roman: 'Pehle PO load karein ya item scan karein', ur: 'پہلے پی او لوڈ کریں یا آئٹم اسکین کریں' },
  'pwh.makePoHint': { key: 'pwh.makePoHint', en: 'Create a new PO in ERP ▸ Purchase ▸ PO', roman: 'ERP ▸ Purchase ▸ PO se naya PO banayein', ur: 'ای آر پی ▸ خریداری ▸ پی او سے نیا پی او بنائیں' },
  'pwh.scanPh': { key: 'pwh.scanPh', en: '🔎 Scan or type name / code…', roman: '🔎 Scan karein ya naam / code likhein…', ur: '🔎 اسکین کریں یا نام / کوڈ لکھیں…' },
  'pwh.grnQueued': { key: 'pwh.grnQueued', en: 'Offline — GRN saved to the queue', roman: 'Offline — GRN queue mein save ho gaya', ur: 'آف لائن — جی آر این قطار میں محفوظ ہو گیا' },
  'pwh.pickPoAuto': { key: 'pwh.pickPoAuto', en: 'Select PO — auto-load for GRN', roman: 'PO select karein — auto-load for GRN', ur: 'پی او منتخب کریں — جی آر این کے لیے آٹو لوڈ' },
  'pwh.noLines': { key: 'pwh.noLines', en: 'No lines — change the search', roman: 'Koi line nahi — search badlein', ur: 'کوئی لائن نہیں — تلاش بدلیں' },
  'pwh.multiMatchesTail': { key: 'pwh.multiMatchesTail', en: ' matches — pick from the list', roman: ' matches — list se chunein', ur: ' میچز — فہرست سے چنیں' },
  'pwh.scanBarcode': { key: 'pwh.scanBarcode', en: 'Scan barcode / code', roman: 'Barcode / code scan karein', ur: 'بارکوڈ / کوڈ اسکین کریں' },
  'pwh.noCountSheet': { key: 'pwh.noCountSheet', en: 'No open count sheet', roman: 'Koi open count sheet nahi', ur: 'کوئی کھلی کاؤنٹ شیٹ نہیں' },
  'pwh.binPh': { key: 'pwh.binPh', en: 'Pick a bin… (e.g. A-01)', roman: 'Bin chunein… (e.g. A-01)', ur: 'بن چنیں… (مثلاً A-01)' },
  'pwh.pickBothBins': { key: 'pwh.pickBothBins', en: 'Pick both bins first', roman: 'Pehle dono bins chunein', ur: 'پہلے دونوں بنز چنیں' },
  'pwh.noLocalCounted': { key: 'pwh.noLocalCounted', en: 'No local counts', roman: 'Koi local counted nahi', ur: 'کوئی مقامی گنتھی نہیں' },
  'pwh.noPendingPo': { key: 'pwh.noPendingPo', en: 'No pending POs', roman: 'Koi pending PO nahi', ur: 'کوئی زیرِ التوا پی او نہیں' },
  'pwh.poDetailFail': { key: 'pwh.poDetailFail', en: 'PO details not found', roman: 'PO detail nahi mila', ur: 'پی او تفصیل نہیں ملی' },
  'pwh.pickSheetFirst': { key: 'pwh.pickSheetFirst', en: 'Pick a sheet first', roman: 'Pehle sheet chunein', ur: 'پہلے شیٹ چنیں' },
  'pwh.putawayDone': { key: 'pwh.putawayDone', en: '✅ Put-away complete', roman: '✅ Put-away ho gaya', ur: '✅ پٹ اوے مکمل' },
  'pwh.transferDone': { key: 'pwh.transferDone', en: '✅ Transfer complete', roman: '✅ Transfer ho gaya', ur: '✅ ٹرانسفر ہو گیا' },
  'pwh.pickBinFirst': { key: 'pwh.pickBinFirst', en: 'Pick a bin first', roman: 'Pehle bin chunein', ur: 'پہلے بن چنیں' },
  'pwh.pickBothBins2': { key: 'pwh.pickBothBins2', en: 'Pick both bins', roman: 'Dono bins chunein', ur: 'دونوں بنز چنیں' },
  'pwh.transferBtn': { key: 'pwh.transferBtn', en: '🔄 Transfer', roman: '🔄 Transfer karein', ur: '🔄 ٹرانسفر کریں' },
  'pwh.addItem': { key: 'pwh.addItem', en: 'Add an item', roman: 'Item add karein', ur: 'آئٹم شامل کریں' },
  'pwh.sheetPh': { key: 'pwh.sheetPh', en: 'Pick a sheet…', roman: 'Sheet chunein…', ur: 'شیٹ چنیں…' },
  'pwh.qtyPositive': { key: 'pwh.qtyPositive', en: 'Make qty >0', roman: 'Qty >0 karein', ur: 'qty >0 کریں' },
  'pwh.increase': { key: 'pwh.increase', en: 'Increase', roman: 'Zyada karein', ur: 'زیادہ کریں' },
  'pwh.pickBin': { key: 'pwh.pickBin', en: 'Pick a bin', roman: 'Bin chunein', ur: 'بن چنیں' },
  'pwh.decrease': { key: 'pwh.decrease', en: 'Decrease', roman: 'Kam karein', ur: 'کم کریں' },
  'pwh.qtyBad': { key: 'pwh.qtyBad', en: 'Invalid qty', roman: 'Qty ghalat', ur: 'qty غلط' },
  'acc.vfdEnd': { key: 'acc.vfdEnd', en: 'changes nothing (each document gets only one voucher).', roman: 'kuch nahi badlega (har document ka sirf ek voucher banta hai).', ur: 'کچھ نہیں بدلتا (ہر دستاویز کا صرف ایک واؤچر بنتا ہے)۔' },
  'acc.noBank': { key: 'acc.noBank', en: 'No bank account — create one in Chart of accounts', roman: 'Koi bank account nahi — Chart of accounts mein banayein', ur: 'کوئی بینک اکاؤنٹ نہیں — چارٹ آف اکاؤنٹس میں بنائیں' },
  'acc.voidConfirm': { key: 'acc.voidConfirm', en: 'Void this voucher? It will be removed from the balance.', roman: 'Ye voucher void karein? Balance se hat jayega.', ur: 'یہ واؤچر void کریں؟ بیلنس سے ہٹ جائے گا۔' },
  'acc.vouchersFromDocs': { key: 'acc.vouchersFromDocs', en: '🧮 Create vouchers from old documents', roman: '🧮 Purane documents se vouchers banayein', ur: '🧮 پرانے دستاویزات سے واؤچر بنائیں' },
  'acc.unbalanced': { key: 'acc.unbalanced', en: 'Debit and credit are not equal (difference ', roman: 'Debit aur credit barabar nahi (farq ', ur: 'ڈیبٹ اور کریڈٹ برابر نہیں (فرق ' },
  'acc.noCashMoves': { key: 'acc.noCashMoves', en: 'No cash movements in this range', roman: 'Is range mein koi cash movement nahi', ur: 'اس رینج میں کوئی کیش موومنٹ نہیں' },
  'acc.dashFail': { key: 'acc.dashFail', en: 'Accounting dashboard failed to load', roman: 'Accounting dashboard load nahi hua', ur: 'اکاؤنٹنگ ڈیش بورڈ لوڈ نہیں ہوا' },
  'acc.noBankEntries': { key: 'acc.noBankEntries', en: 'No bank entries in this range', roman: 'Is range mein koi bank entry nahi', ur: 'اس رینج میں کوئی بینک انٹری نہیں' },
  'acc.walletFail': { key: 'acc.walletFail', en: 'Wallet component failed to load', roman: 'Wallet component load nahi hua', ur: 'والٹ کمپوننٹ لوڈ نہیں ہوا' },
  'acc.noVouchers': { key: 'acc.noVouchers', en: 'No vouchers in this range', roman: 'Is range mein koi voucher nahi', ur: 'اس رینج میں کوئی واؤچر نہیں' },
  'acc.noExpenses': { key: 'acc.noExpenses', en: 'No expenses in this range', roman: 'Is range mein koi expense nahi', ur: 'اس رینج میں کوئی خرچ نہیں' },
  'acc.noEntries': { key: 'acc.noEntries', en: 'No entries in this range', roman: 'Is range mein koi entry nahi', ur: 'اس رینج میں کوئی انٹری نہیں' },
  'acc.tbFail': { key: 'acc.tbFail', en: 'Trial balance failed to load', roman: 'Trial balance load nahi hui', ur: 'ٹرائل بیلنس لوڈ نہیں ہوئی' },
  'acc.bsFail': { key: 'acc.bsFail', en: 'Balance sheet failed to load', roman: 'Balance sheet load nahi hui', ur: 'بیلنس شیٹ لوڈ نہیں ہوئی' },
  'acc.bankBookFail': { key: 'acc.bankBookFail', en: 'Bank book failed to load', roman: 'Bank book load nahi hua', ur: 'بینک بک لوڈ نہیں ہوا' },
  'acc.cashBookFail': { key: 'acc.cashBookFail', en: 'Cash book failed to load', roman: 'Cash book load nahi hua', ur: 'کیش بک لوڈ نہیں ہوا' },
  'acc.vouchersFail': { key: 'acc.vouchersFail', en: 'Vouchers failed to load', roman: 'Vouchers load nahi hue', ur: 'واؤچرز لوڈ نہیں ہوئے' },
  'acc.voucherFail': { key: 'acc.voucherFail', en: 'Voucher failed to load', roman: 'Voucher load nahi hua', ur: 'واؤچر لوڈ نہیں ہوا' },
  'acc.receivables': { key: 'acc.receivables', en: 'Receivables (credit)', roman: 'Receivables (udhaar)', ur: 'وصولی (ادھار)' },
  'acc.ledgerFail': { key: 'acc.ledgerFail', en: 'Ledger failed to load', roman: 'Ledger load nahi hua', ur: 'لیجر لوڈ نہیں ہوا' },
  'acc.openAttachment': { key: 'acc.openAttachment', en: '📎 Open attachment', roman: '📎 Attachment kholein', ur: '📎 اٹیچمنٹ کھولیں' },
  'acc.noValidLines': { key: 'acc.noValidLines', en: 'No valid lines', roman: 'Koi valid line nahi', ur: 'کوئی درست لائن نہیں' },
  'acc.enterAmount': { key: 'acc.enterAmount', en: 'Enter the amount', roman: 'Amount darj karein', ur: 'رقم درج کریں' },
  'acc.approveAll': { key: 'acc.approveAll', en: 'Approve all', roman: 'Sab approve karein', ur: 'سب منظور کریں' },
  'acc.plFail': { key: 'acc.plFail', en: 'P&L failed to load', roman: 'P&L load nahi hua', ur: 'پی اینڈ ایل لوڈ نہیں ہوا' },
  'acc.nameReq': { key: 'acc.nameReq', en: 'Name is required', roman: 'Naam zaroori hai', ur: 'نام ضروری ہے' },
  'acc.noBalances': { key: 'acc.noBalances', en: 'No balances', roman: 'Koi balance nahi', ur: 'کوئی بیلنس نہیں' },
  'acc.addLine': { key: 'acc.addLine', en: 'Add a line', roman: 'Line add karein', ur: 'لائن شامل کریں' },
  'acc.noEntriesShort': { key: 'acc.noEntriesShort', en: 'No entries', roman: 'Koi entry nahi', ur: 'کوئی انٹری نہیں' },
  'acc.noData': { key: 'acc.noData', en: 'No data', roman: 'Koi data nahi', ur: 'کوئی ڈیٹا نہیں' },
  'sc2.permsSaved': { key: 'sc2.permsSaved', en: 'Permissions saved ✅', roman: 'Permissions save ho gayeen ✅', ur: 'اجازتیں محفوظ ہو گئیں ✅' },
  'sc2.usernameReq': { key: 'sc2.usernameReq', en: 'Username is required', roman: 'Username zaroori hai', ur: 'یوزر نیم ضروری ہے' },
  'pos.bulkScanDone': { key: 'pos.bulkScanDone', en: 'Bulk scan done — ', roman: 'Bulk scan khatam — ', ur: 'بلک اسکین مکمل — ' },
  'pos.productNotFound': { key: 'pos.productNotFound', en: 'Product not found: ', roman: 'Product nahi mila: ', ur: 'پروڈکٹ نہیں ملا: ' },
  'pos.nothingSelected': { key: 'pos.nothingSelected', en: 'Nothing selected', roman: 'Koi select nahi', ur: 'کچھ منتخب نہیں' },
  'pos.nameReq': { key: 'pos.nameReq', en: 'Name is required', roman: 'Name zaroori hai', ur: 'نام ضروری ہے' },
  'pos.cartEmpty': { key: 'pos.cartEmpty', en: 'Cart is empty', roman: 'Cart khali hai', ur: 'کارٹ خالی ہے' },
  'pos.enterPoints': { key: 'pos.enterPoints', en: 'Enter points', roman: 'Points daalein', ur: 'پوائنٹس درج کریں' },
  'pos.pointsTooMany': { key: 'pos.pointsTooMany', en: 'Cannot use that many points', roman: 'Itne points use nahi ho sakte', ur: 'اتنے پوائنٹس استعمال نہیں ہو سکتے' },
  'pos.cashFull': { key: 'pos.cashFull', en: 'Cash sale: pay the full bill — remaining ', roman: 'Cash sale: poora bill pay karein — baqi ', ur: 'کیش سیل: پورا بل ادا کریں — باقی ' },
  'pos.creditNeedsCustomer': { key: 'pos.creditNeedsCustomer', en: 'Select a customer for credit', roman: 'Udhaar ke liye customer select karein', ur: 'ادھار کے لیے کسٹمر منتخب کریں' },
  'pos.customerBlocked': { key: 'pos.customerBlocked', en: 'Customer account inactive/blocked — credit not allowed', roman: 'Customer account inactive / blocked — udhaar nahi de sakte', ur: 'کسٹمر اکاؤنٹ غیر فعال/بلاک — ادھار نہیں دیا جا سکتا' },
  'pos.limitExceeded': { key: 'pos.limitExceeded', en: 'Credit limit exceeded — limit ', roman: 'Credit limit exceeded — limit ', ur: 'کریڈٹ حد سے زیادہ — حد ' },
  'pos.fullPayReq': { key: 'pos.fullPayReq', en: 'Full payment required — remaining ', roman: 'Full payment required — baqi ', ur: 'مکمل ادائیگی ضروری — باقی ' },
  'pos.noPayment': { key: 'pos.noPayment', en: 'No payment entered', roman: 'Koi payment nahi dali', ur: 'کوئی ادائیگی درج نہیں' },
  'pos.pointsCap': { key: 'pos.pointsCap', en: 'Points cap: max on this bill ', roman: 'Points cap: is bill par max ', ur: 'پوائنٹس کی حد: اس بل پر زیادہ سے زیادہ ' },
  'pos.sendVia': { key: 'pos.sendVia', en: 'Send: share via WhatsApp / Email (', roman: 'Send: WhatsApp / Email se share karein (', ur: 'بھیجیں: واٹس ایپ / ای میل سے شیئر کریں (' },
  'pos.offlineQueued': { key: 'pos.offlineQueued', en: 'Offline — bill queued', roman: 'Offline bill queue ho gaya', ur: 'آف لائن — بل قطار میں' },
  'pos.billHeld': { key: 'pos.billHeld', en: 'Bill held ⏸', roman: 'Bill hold ho gaya ⏸', ur: 'بل ہول ہو گیا ⏸' },
...
window.MockAPI = {
  ...
  'pwa.bootstrap': p => {
    ...
    if(app==='wh'){
      ...
      base.customers = CUSTOMERS.slice(0,20).map(c=>({id:c.id, name:c.name, phone:c.phone, bal:c.balance, sm:c.salesmanId||''}));  /* v2.31.2 */
      base.salesmanId = 'USR3';   /* demo session = salesman USR3 */
      base.myCustomers = base.customers.filter(c=>c.sm===base.salesmanId);   /* v2.31.2 (r14/F5) */
